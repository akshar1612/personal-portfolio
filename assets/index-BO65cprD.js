...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function kp(){return new qi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xd(),fragmentShader:`
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function Bp(){return new qi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xd(),fragmentShader:`
...
`].filter(to).join(`
`)),o=kf(o),o=$p(o,n),o=Kp(o,n),a=kf(a),a=$p(a,n),a=Kp(a,n),o=Zp(o),a=Zp(a),n.isRawShaderMaterial!==!0&&(g=`#version 300 es
...
`)+`
`+c);const _=g+p+o,S=g+c+a,R=Yp(r,r.VERTEX_SHADER,_),w=Yp(r,r.FRAGMENT_SHADER,S);r.attachShader(y,R),r.attachShader(y,w),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(T){if(t.debug.checkShaderErrors){const H=r.getProgramInfoLog(y).trim(),F=r.getShaderInfoLog(R).trim(),j=r.getShaderInfoLog(w).trim();let Q=!0,G=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(Q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,R,w);else{const J=qp(r,R,"vertex"),L=qp(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
}`;function w1(t,e,n){let i=new j_;const r=new Ue,s=new Ue,o=new _t,a=new S1({depthPacking:my}),l=new M1,u={},f=n.maxTextureSize,h={[Yi]:en,[en]:Yi,[si]:si},d=new qi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ue},radius:{value:4}},vertexShader:E1,fragmentShader:T1}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new Rn;x.setAttribute("position",new hn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new cn(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=E_;let c=this.type;this.render=function(w,A,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const V=t.getRenderTarget(),v=t.getActiveCubeFace(),T=t.getActiveMipmapLevel(),H=t.state;H.setBlending(Vi),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const F=c!==ni&&this.type===ni,j=c===ni&&this.type!==ni;for(let Q=0,G=w.length;Q<G;Q++){const J=w[Q],L=J.shadow;if(L===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const $=L.getFrameExtents();if(r.multiply($),s.copy(L.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/$.x),r.x=s.x*$.x,L.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/$.y),r.y=s.y*$.y,L.mapSize.y=s.y)),L.map===null||F===!0||j===!0){const se=this.type!==ni?{minFilter:Tn,magFilter:Tn}:{};L.map!==null&&L.map.dispose(),L.map=new Tr(r.x,r.y,se),L.map.texture.name=J.name+".shadowMap",L.camera.updateProjectionMatrix()}t.setRenderTarget(L.map),t.clear();const Z=L.getViewportCount();for(let se=0;se<Z;se++){const Ee=L.getViewport(se);o.set(s.x*Ee.x,s.y*Ee.y,s.x*Ee.z,s.y*Ee.w),H.viewport(o),L.updateMatrices(J,se),i=L.getFrustum(),S(A,P,L.camera,J,this.type)}L.isPointLightShadow!==!0&&this.type===ni&&g(L,P),L.needsUpdate=!1}c=this.type,p.needsUpdate=!1,t.setRenderTarget(V,v,T)};function g(w,A){const P=e.update(y);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Tr(r.x,r.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(A,null,P,d,y,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(A,null,P,m,y,null)}function _(w,A,P,V){let v=null;const T=P.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(T!==void 0)v=T;else if(v=P.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const H=v.uuid,F=A.uuid;let j=u[H];j===void 0&&(j={},u[H]=j);let Q=j[F];Q===void 0&&(Q=v.clone(),j[F]=Q,A.addEventListener("dispose",R)),v=Q}if(v.visible=A.visible,v.wireframe=A.wireframe,V===ni?v.side=A.shadowSide!==null?A.shadowSide:A.side:v.side=A.shadowSide!==null?A.shadowSide:h[A.side],v.alphaMap=A.alphaMap,v.alphaTest=A.alphaTest,v.map=A.map,v.clipShadows=A.clipShadows,v.clippingPlanes=A.clippingPlanes,v.clipIntersection=A.clipIntersection,v.displacementMap=A.displacementMap,v.displacementScale=A.displacementScale,v.displacementBias=A.displacementBias,v.wireframeLinewidth=A.wireframeLinewidth,v.linewidth=A.linewidth,P.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const H=t.properties.get(v);H.light=P}return v}function S(w,A,P,V,v){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&v===ni)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,w.matrixWorld);const F=e.update(w),j=w.material;if(Array.isArray(j)){const Q=F.groups;for(let G=0,J=Q.length;G<J;G++){const L=Q[G],$=j[L.materialIndex];if($&&$.visible){const Z=_(w,$,V,v);w.onBeforeShadow(t,w,A,P,F,Z,L),t.renderBufferDirect(P,null,F,Z,w,L),w.onAfterShadow(t,w,A,P,F,Z,L)}}}else if(j.visible){const Q=_(w,j,V,v);w.onBeforeShadow(t,w,A,P,F,Q,null),t.renderBufferDirect(P,null,F,Q,w,null),w.onAfterShadow(t,w,A,P,F,Q,null)}}const H=w.children;for(let F=0,j=H.length;F<j;F++)S(H[F],A,P,V,v)}function R(w){w.target.removeEventListener("dispose",R);for(const P in u){const V=u[P],v=w.target.uuid;v in V&&(V[v].dispose(),delete V[v])}}}const A1={[Qc]:Jc,[ef]:rf,[tf]:sf,[Es]:nf,[Jc]:Qc,[rf]:ef,[sf]:tf,[nf]:Es};function C1(t){function e(){let D=!1;const de=new _t;let W=null;const K=new _t(0,0,0,0);return{setMask:function(ue){W!==ue&&!D&&(t.colorMask(ue,ue,ue,ue),W=ue)},setLocked:function(ue){D=ue},setClear:function(ue,he,Ve,vt,jt){jt===!0&&(ue*=vt,he*=vt,Ve*=vt),de.set(ue,he,Ve,vt),K.equals(de)===!1&&(t.clearColor(ue,he,Ve,vt),K.copy(de))},reset:function(){D=!1,W=null,K.set(-1,0,0,0)}}}function n(){let D=!1,de=!1,W=null,K=null,ue=null;return{setReversed:function(he){de=he},setTest:function(he){he?fe(t.DEPTH_TEST):le(t.DEPTH_TEST)},setMask:function(he){W!==he&&!D&&(t.depthMask(he),W=he)},setFunc:function(he){if(de&&(he=A1[he]),K!==he){switch(he){case Qc:t.depthFunc(t.NEVER);break;case Jc:t.depthFunc(t.ALWAYS);break;case ef:t.depthFunc(t.LESS);break;case Es:t.depthFunc(t.LEQUAL);break;case tf:t.depthFunc(t.EQUAL);break;case nf:t.depthFunc(t.GEQUAL);break;case rf:t.depthFunc(t.GREATER);break;case sf:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}K=he}},setLocked:function(he){D=he},setClear:function(he){ue!==he&&(t.clearDepth(he),ue=he)},reset:function(){D=!1,W=null,K=null,ue=null}}}function i(){let D=!1,de=null,W=null,K=null,ue=null,he=null,Ve=null,vt=null,jt=null;return{setTest:function(je){D||(je?fe(t.STENCIL_TEST):le(t.STENCIL_TEST))},setMask:function(je){de!==je&&!D&&(t.stencilMask(je),de=je)},setFunc:function(je,Yt,Kn){(W!==je||K!==Yt||ue!==Kn)&&(t.stencilFunc(je,Yt,Kn),W=je,K=Yt,ue=Kn)},setOp:function(je,Yt,Kn){(he!==je||Ve!==Yt||vt!==Kn)&&(t.stencilOp(je,Yt,Kn),he=je,Ve=Yt,vt=Kn)},setLocked:function(je){D=je},setClear:function(je){jt!==je&&(t.clearStencil(je),jt=je)},reset:function(){D=!1,de=null,W=null,K=null,ue=null,he=null,Ve=null,vt=null,jt=null}}}const r=new e,s=new n,o=new i,a=new WeakMap,l=new WeakMap;let u={},f={},h=new WeakMap,d=[],m=null,x=!1,y=null,p=null,c=null,g=null,_=null,S=null,R=null,w=new Ke(0,0,0),A=0,P=!1,V=null,v=null,T=null,H=null,F=null;const j=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Q=!1,G=0;const J=t.getParameter(t.VERSION);J.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(J)[1]),Q=G>=1):J.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),Q=G>=2);let L=null,$={};const Z=t.getParameter(t.SCISSOR_BOX),se=t.getParameter(t.VIEWPORT),Ee=new _t().fromArray(Z),Oe=new _t().fromArray(se);function X(D,de,W,K){const ue=new Uint8Array(4),he=t.createTexture();t.bindTexture(D,he),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ve=0;Ve<W;Ve++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(de,0,t.RGBA,1,1,K,0,t.RGBA,t.UNSIGNED_BYTE,ue):t.texImage2D(de+Ve,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ue);return he}const ne={};ne[t.TEXTURE_2D]=X(t.TEXTURE_2D,t.TEXTURE_2D,1),ne[t.TEXTURE_CUBE_MAP]=X(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[t.TEXTURE_2D_ARRAY]=X(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ne[t.TEXTURE_3D]=X(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),fe(t.DEPTH_TEST),s.setFunc(Es),ke(!1),We(cp),fe(t.CULL_FACE),b(Vi);function fe(D){u[D]!==!0&&(t.enable(D),u[D]=!0)}function le(D){u[D]!==!1&&(t.disable(D),u[D]=!1)}function Le(D,de){return f[D]!==de?(t.bindFramebuffer(D,de),f[D]=de,D===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=de),D===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=de),!0):!1}function we(D,de){let W=d,K=!1;if(D){W=h.get(de),W===void 0&&(W=[],h.set(de,W));const ue=D.textures;if(W.length!==ue.length||W[0]!==t.COLOR_ATTACHMENT0){for(let he=0,Ve=ue.length;he<Ve;he++)W[he]=t.COLOR_ATTACHMENT0+he;W.length=ue.length,K=!0}}else W[0]!==t.BACK&&(W[0]=t.BACK,K=!0);K&&t.drawBuffers(W)}function ze(D){return m!==D?(t.useProgram(D),m=D,!0):!1}const Je={[ur]:t.FUNC_ADD,[Hx]:t.FUNC_SUBTRACT,[Vx]:t.FUNC_REVERSE_SUBTRACT};Je[Gx]=t.MIN,Je[Wx]=t.MAX;const He={[Xx]:t.ZERO,[jx]:t.ONE,[Yx]:t.SRC_COLOR,[Kc]:t.SRC_ALPHA,[Jx]:t.SRC_ALPHA_SATURATE,[Zx]:t.DST_COLOR,[$x]:t.DST_ALPHA,[qx]:t.ONE_MINUS_SRC_COLOR,[Zc]:t.ONE_MINUS_SRC_ALPHA,[Qx]:t.ONE_MINUS_DST_COLOR,[Kx]:t.ONE_MINUS_DST_ALPHA,[ey]:t.CONSTANT_COLOR,[ty]:t.ONE_MINUS_CONSTANT_COLOR,[ny]:t.CONSTANT_ALPHA,[iy]:t.ONE_MINUS_CONSTANT_ALPHA};function b(D,de,W,K,ue,he,Ve,vt,jt,je){if(D===Vi){x===!0&&(le(t.BLEND),x=!1);return}if(x===!1&&(fe(t.BLEND),x=!0),D!==zx){if(D!==y||je!==P){if((p!==ur||_!==ur)&&(t.blendEquation(t.FUNC_ADD),p=ur,_=ur),je)switch(D){case hs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case fp:t.blendFunc(t.ONE,t.ONE);break;case dp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case hp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case hs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case fp:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case dp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case hp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}c=null,g=null,S=null,R=null,w.set(0,0,0),A=0,y=D,P=je}return}ue=ue||de,he=he||W,Ve=Ve||K,(de!==p||ue!==_)&&(t.blendEquationSeparate(Je[de],Je[ue]),p=de,_=ue),(W!==c||K!==g||he!==S||Ve!==R)&&(t.blendFuncSeparate(He[W],He[K],He[he],He[Ve]),c=W,g=K,S=he,R=Ve),(vt.equals(w)===!1||jt!==A)&&(t.blendColor(vt.r,vt.g,vt.b,jt),w.copy(vt),A=jt),y=D,P=!1}function tn(D,de){D.side===si?le(t.CULL_FACE):fe(t.CULL_FACE);let W=D.side===en;de&&(W=!W),ke(W),D.blending===hs&&D.transparent===!1?b(Vi):b(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),s.setFunc(D.depthFunc),s.setTest(D.depthTest),s.setMask(D.depthWrite),r.setMask(D.colorWrite);const K=D.stencilWrite;o.setTest(K),K&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),it(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?fe(t.SAMPLE_ALPHA_TO_COVERAGE):le(t.SAMPLE_ALPHA_TO_COVERAGE)}function ke(D){V!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),V=D)}function We(D){D!==Ox?(fe(t.CULL_FACE),D!==v&&(D===cp?t.cullFace(t.BACK):D===kx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):le(t.CULL_FACE),v=D}function Ce(D){D!==T&&(Q&&t.lineWidth(D),T=D)}function it(D,de,W){D?(fe(t.POLYGON_OFFSET_FILL),(H!==de||F!==W)&&(t.polygonOffset(de,W),H=de,F=W)):le(t.POLYGON_OFFSET_FILL)}function be(D){D?fe(t.SCISSOR_TEST):le(t.SCISSOR_TEST)}function C(D){D===void 0&&(D=t.TEXTURE0+j-1),L!==D&&(t.activeTexture(D),L=D)}function M(D,de,W){W===void 0&&(L===null?W=t.TEXTURE0+j-1:W=L);let K=$[W];K===void 0&&(K={type:void 0,texture:void 0},$[W]=K),(K.type!==D||K.texture!==de)&&(L!==W&&(t.activeTexture(W),L=W),t.bindTexture(D,de||ne[D]),K.type=D,K.texture=de)}function O(){const D=$[L];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function q(){try{t.compressedTexImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ee(){try{t.compressedTexImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Y(){try{t.texSubImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ye(){try{t.texSubImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ae(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function me(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Xe(){try{t.texStorage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ie(){try{t.texStorage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ge(){try{t.texImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Re(){try{t.texImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Pe(D){Ee.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),Ee.copy(D))}function _e(D){Oe.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),Oe.copy(D))}function Be(D,de){let W=l.get(de);W===void 0&&(W=new WeakMap,l.set(de,W));let K=W.get(D);K===void 0&&(K=t.getUniformBlockIndex(de,D.name),W.set(D,K))}function De(D,de){const K=l.get(de).get(D);a.get(de)!==K&&(t.uniformBlockBinding(de,K,D.__bindingPointIndex),a.set(de,K))}function tt(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),u={},L=null,$={},f={},h=new WeakMap,d=[],m=null,x=!1,y=null,p=null,c=null,g=null,_=null,S=null,R=null,w=new Ke(0,0,0),A=0,P=!1,V=null,v=null,T=null,H=null,F=null,Ee.set(0,0,t.canvas.width,t.canvas.height),Oe.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:fe,disable:le,bindFramebuffer:Le,drawBuffers:we,useProgram:ze,setBlending:b,setMaterial:tn,setFlipSided:ke,setCullFace:We,setLineWidth:Ce,setPolygonOffset:it,setScissorTest:be,activeTexture:C,bindTexture:M,unbindTexture:O,compressedTexImage2D:q,compressedTexImage3D:ee,texImage2D:ge,texImage3D:Re,updateUBOMapping:Be,uniformBlockBinding:De,texStorage2D:Xe,texStorage3D:ie,texSubImage2D:Y,texSubImage3D:ye,compressedTexSubImage2D:ae,compressedTexSubImage3D:me,scissor:Pe,viewport:_e,reset:tt}}function nm(t,e,n,i){const r=R1(i);switch(n){case P_:return t*e;case L_:return t*e;case D_:return t*e*2;case I_:return t*e/r.components*r.byteLength;case Bd:return t*e/r.components*r.byteLength;case N_:return t*e*2/r.components*r.byteLength;case zd:return t*e*2/r.components*r.byteLength;case b_:return t*e*3/r.components*r.byteLength;case kn:return t*e*4/r.components*r.byteLength;case Hd:return t*e*4/r.components*r.byteLength;case Wa:case Xa:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case ja:case Ya:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case ff:case hf:return Math.max(t,16)*Math.max(e,8)/4;case cf:case df:return Math.max(t,8)*Math.max(e,8)/2;case pf:case mf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case gf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case _f:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case vf:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case xf:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case yf:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case Sf:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case Mf:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Ef:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case Tf:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case wf:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Af:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case Cf:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case Rf:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case Pf:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case bf:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case qa:case Lf:case Df:return Math.ceil(t/4)*Math.ceil(e/4)*16;case U_:case If:return Math.ceil(t/4)*Math.ceil(e/4)*8;case Nf:case Uf:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function R1(t){switch(t){case mi:case A_:return{byteLength:1,components:1};case bo:case C_:case Fo:return{byteLength:2,components:1};case Od:case kd:return{byteLength:2,components:4};case Er:case Fd:case li:return{byteLength:4,components:1};case R_:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function P1(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new Ue,f=new WeakMap;let h;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(C,M){return m?new OffscreenCanvas(C,M):wl("canvas")}function y(C,M,O){let q=1;const ee=be(C);if((ee.width>O||ee.height>O)&&(q=O/Math.max(ee.width,ee.height)),q<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const Y=Math.floor(q*ee.width),ye=Math.floor(q*ee.height);h===void 0&&(h=x(Y,ye));const ae=M?x(Y,ye):h;return ae.width=Y,ae.height=ye,ae.getContext("2d").drawImage(C,0,0,Y,ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+Y+"x"+ye+")."),ae}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),C;return C}function p(C){return C.generateMipmaps&&C.minFilter!==Tn&&C.minFilter!==On}function c(C){t.generateMipmap(C)}function g(C,M,O,q,ee=!1){if(C!==null){if(t[C]!==void 0)return t[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let Y=M;if(M===t.RED&&(O===t.FLOAT&&(Y=t.R32F),O===t.HALF_FLOAT&&(Y=t.R16F),O===t.UNSIGNED_BYTE&&(Y=t.R8)),M===t.RED_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.R8UI),O===t.UNSIGNED_SHORT&&(Y=t.R16UI),O===t.UNSIGNED_INT&&(Y=t.R32UI),O===t.BYTE&&(Y=t.R8I),O===t.SHORT&&(Y=t.R16I),O===t.INT&&(Y=t.R32I)),M===t.RG&&(O===t.FLOAT&&(Y=t.RG32F),O===t.HALF_FLOAT&&(Y=t.RG16F),O===t.UNSIGNED_BYTE&&(Y=t.RG8)),M===t.RG_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RG8UI),O===t.UNSIGNED_SHORT&&(Y=t.RG16UI),O===t.UNSIGNED_INT&&(Y=t.RG32UI),O===t.BYTE&&(Y=t.RG8I),O===t.SHORT&&(Y=t.RG16I),O===t.INT&&(Y=t.RG32I)),M===t.RGB_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),O===t.UNSIGNED_INT&&(Y=t.RGB32UI),O===t.BYTE&&(Y=t.RGB8I),O===t.SHORT&&(Y=t.RGB16I),O===t.INT&&(Y=t.RGB32I)),M===t.RGBA_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),O===t.UNSIGNED_INT&&(Y=t.RGBA32UI),O===t.BYTE&&(Y=t.RGBA8I),O===t.SHORT&&(Y=t.RGBA16I),O===t.INT&&(Y=t.RGBA32I)),M===t.RGB&&O===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),M===t.RGBA){const ye=ee?Sl:$e.getTransfer(q);O===t.FLOAT&&(Y=t.RGBA32F),O===t.HALF_FLOAT&&(Y=t.RGBA16F),O===t.UNSIGNED_BYTE&&(Y=ye===ot?t.SRGB8_ALPHA8:t.RGBA8),O===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),O===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function _(C,M){let O;return C?M===null||M===Er||M===As?O=t.DEPTH24_STENCIL8:M===li?O=t.DEPTH32F_STENCIL8:M===bo&&(O=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Er||M===As?O=t.DEPTH_COMPONENT24:M===li?O=t.DEPTH_COMPONENT32F:M===bo&&(O=t.DEPTH_COMPONENT16),O}function S(C,M){return p(C)===!0||C.isFramebufferTexture&&C.minFilter!==Tn&&C.minFilter!==On?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function R(C){const M=C.target;M.removeEventListener("dispose",R),A(M),M.isVideoTexture&&f.delete(M)}function w(C){const M=C.target;M.removeEventListener("dispose",w),V(M)}function A(C){const M=i.get(C);if(M.__webglInit===void 0)return;const O=C.source,q=d.get(O);if(q){const ee=q[M.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&P(C),Object.keys(q).length===0&&d.delete(O)}i.remove(C)}function P(C){const M=i.get(C);t.deleteTexture(M.__webglTexture);const O=C.source,q=d.get(O);delete q[M.__cacheKey],o.memory.textures--}function V(C){const M=i.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(M.__webglFramebuffer[q]))for(let ee=0;ee<M.__webglFramebuffer[q].length;ee++)t.deleteFramebuffer(M.__webglFramebuffer[q][ee]);else t.deleteFramebuffer(M.__webglFramebuffer[q]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[q])}else{if(Array.isArray(M.__webglFramebuffer))for(let q=0;q<M.__webglFramebuffer.length;q++)t.deleteFramebuffer(M.__webglFramebuffer[q]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let q=0;q<M.__webglColorRenderbuffer.length;q++)M.__webglColorRenderbuffer[q]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[q]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const O=C.textures;for(let q=0,ee=O.length;q<ee;q++){const Y=i.get(O[q]);Y.__webglTexture&&(t.deleteTexture(Y.__webglTexture),o.memory.textures--),i.remove(O[q])}i.remove(C)}let v=0;function T(){v=0}function H(){const C=v;return C>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),v+=1,C}function F(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function j(C,M){const O=i.get(C);if(C.isVideoTexture&&Ce(C),C.isRenderTargetTexture===!1&&C.version>0&&O.__version!==C.version){const q=C.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(O,C,M);return}}n.bindTexture(t.TEXTURE_2D,O.__webglTexture,t.TEXTURE0+M)}function Q(C,M){const O=i.get(C);if(C.version>0&&O.__version!==C.version){Oe(O,C,M);return}n.bindTexture(t.TEXTURE_2D_ARRAY,O.__webglTexture,t.TEXTURE0+M)}function G(C,M){const O=i.get(C);if(C.version>0&&O.__version!==C.version){Oe(O,C,M);return}n.bindTexture(t.TEXTURE_3D,O.__webglTexture,t.TEXTURE0+M)}function J(C,M){const O=i.get(C);if(C.version>0&&O.__version!==C.version){X(O,C,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,O.__webglTexture,t.TEXTURE0+M)}const L={[lf]:t.REPEAT,[pr]:t.CLAMP_TO_EDGE,[uf]:t.MIRRORED_REPEAT},$={[Tn]:t.NEAREST,[hy]:t.NEAREST_MIPMAP_NEAREST,[sa]:t.NEAREST_MIPMAP_LINEAR,[On]:t.LINEAR,[Au]:t.LINEAR_MIPMAP_NEAREST,[mr]:t.LINEAR_MIPMAP_LINEAR},Z={[vy]:t.NEVER,[Ty]:t.ALWAYS,[xy]:t.LESS,[F_]:t.LEQUAL,[yy]:t.EQUAL,[Ey]:t.GEQUAL,[Sy]:t.GREATER,[My]:t.NOTEQUAL};function se(C,M){if(M.type===li&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===On||M.magFilter===Au||M.magFilter===sa||M.magFilter===mr||M.minFilter===On||M.minFilter===Au||M.minFilter===sa||M.minFilter===mr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,L[M.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,L[M.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,L[M.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,$[M.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,$[M.minFilter]),M.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,Z[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Tn||M.minFilter!==sa&&M.minFilter!==mr||M.type===li&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function Ee(C,M){let O=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",R));const q=M.source;let ee=d.get(q);ee===void 0&&(ee={},d.set(q,ee));const Y=F(M);if(Y!==C.__cacheKey){ee[Y]===void 0&&(ee[Y]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,O=!0),ee[Y].usedTimes++;const ye=ee[C.__cacheKey];ye!==void 0&&(ee[C.__cacheKey].usedTimes--,ye.usedTimes===0&&P(M)),C.__cacheKey=Y,C.__webglTexture=ee[Y].texture}return O}function Oe(C,M,O){let q=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(q=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(q=t.TEXTURE_3D);const ee=Ee(C,M),Y=M.source;n.bindTexture(q,C.__webglTexture,t.TEXTURE0+O);const ye=i.get(Y);if(Y.version!==ye.__version||ee===!0){n.activeTexture(t.TEXTURE0+O);const ae=$e.getPrimaries($e.workingColorSpace),me=M.colorSpace===Li?null:$e.getPrimaries(M.colorSpace),Xe=M.colorSpace===Li||ae===me?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xe);let ie=y(M.image,!1,r.maxTextureSize);ie=it(M,ie);const ge=s.convert(M.format,M.colorSpace),Re=s.convert(M.type);let Pe=g(M.internalFormat,ge,Re,M.colorSpace,M.isVideoTexture);se(q,M);let _e;const Be=M.mipmaps,De=M.isVideoTexture!==!0,tt=ye.__version===void 0||ee===!0,D=Y.dataReady,de=S(M,ie);if(M.isDepthTexture)Pe=_(M.format===Cs,M.type),tt&&(De?n.texStorage2D(t.TEXTURE_2D,1,Pe,ie.width,ie.height):n.texImage2D(t.TEXTURE_2D,0,Pe,ie.width,ie.height,0,ge,Re,null));else if(M.isDataTexture)if(Be.length>0){De&&tt&&n.texStorage2D(t.TEXTURE_2D,de,Pe,Be[0].width,Be[0].height);for(let W=0,K=Be.length;W<K;W++)_e=Be[W],De?D&&n.texSubImage2D(t.TEXTURE_2D,W,0,0,_e.width,_e.height,ge,Re,_e.data):n.texImage2D(t.TEXTURE_2D,W,Pe,_e.width,_e.height,0,ge,Re,_e.data);M.generateMipmaps=!1}else De?(tt&&n.texStorage2D(t.TEXTURE_2D,de,Pe,ie.width,ie.height),D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ie.width,ie.height,ge,Re,ie.data)):n.texImage2D(t.TEXTURE_2D,0,Pe,ie.width,ie.height,0,ge,Re,ie.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){De&&tt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,de,Pe,Be[0].width,Be[0].height,ie.depth);for(let W=0,K=Be.length;W<K;W++)if(_e=Be[W],M.format!==kn)if(ge!==null)if(De){if(D)if(M.layerUpdates.size>0){const ue=nm(_e.width,_e.height,M.format,M.type);for(const he of M.layerUpdates){const Ve=_e.data.subarray(he*ue/_e.data.BYTES_PER_ELEMENT,(he+1)*ue/_e.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,W,0,0,he,_e.width,_e.height,1,ge,Ve,0,0)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,W,0,0,0,_e.width,_e.height,ie.depth,ge,_e.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,W,Pe,_e.width,_e.height,ie.depth,0,_e.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,W,0,0,0,_e.width,_e.height,ie.depth,ge,Re,_e.data):n.texImage3D(t.TEXTURE_2D_ARRAY,W,Pe,_e.width,_e.height,ie.depth,0,ge,Re,_e.data)}else{De&&tt&&n.texStorage2D(t.TEXTURE_2D,de,Pe,Be[0].width,Be[0].height);for(let W=0,K=Be.length;W<K;W++)_e=Be[W],M.format!==kn?ge!==null?De?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,W,0,0,_e.width,_e.height,ge,_e.data):n.compressedTexImage2D(t.TEXTURE_2D,W,Pe,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?D&&n.texSubImage2D(t.TEXTURE_2D,W,0,0,_e.width,_e.height,ge,Re,_e.data):n.texImage2D(t.TEXTURE_2D,W,Pe,_e.width,_e.height,0,ge,Re,_e.data)}else if(M.isDataArrayTexture)if(De){if(tt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,de,Pe,ie.width,ie.height,ie.depth),D)if(M.layerUpdates.size>0){const W=nm(ie.width,ie.height,M.format,M.type);for(const K of M.layerUpdates){const ue=ie.data.subarray(K*W/ie.data.BYTES_PER_ELEMENT,(K+1)*W/ie.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,K,ie.width,ie.height,1,ge,Re,ue)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,ge,Re,ie.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Pe,ie.width,ie.height,ie.depth,0,ge,Re,ie.data);else if(M.isData3DTexture)De?(tt&&n.texStorage3D(t.TEXTURE_3D,de,Pe,ie.width,ie.height,ie.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,ge,Re,ie.data)):n.texImage3D(t.TEXTURE_3D,0,Pe,ie.width,ie.height,ie.depth,0,ge,Re,ie.data);else if(M.isFramebufferTexture){if(tt)if(De)n.texStorage2D(t.TEXTURE_2D,de,Pe,ie.width,ie.height);else{let W=ie.width,K=ie.height;for(let ue=0;ue<de;ue++)n.texImage2D(t.TEXTURE_2D,ue,Pe,W,K,0,ge,Re,null),W>>=1,K>>=1}}else if(Be.length>0){if(De&&tt){const W=be(Be[0]);n.texStorage2D(t.TEXTURE_2D,de,Pe,W.width,W.height)}for(let W=0,K=Be.length;W<K;W++)_e=Be[W],De?D&&n.texSubImage2D(t.TEXTURE_2D,W,0,0,ge,Re,_e):n.texImage2D(t.TEXTURE_2D,W,Pe,ge,Re,_e);M.generateMipmaps=!1}else if(De){if(tt){const W=be(ie);n.texStorage2D(t.TEXTURE_2D,de,Pe,W.width,W.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ge,Re,ie)}else n.texImage2D(t.TEXTURE_2D,0,Pe,ge,Re,ie);p(M)&&c(q),ye.__version=Y.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function X(C,M,O){if(M.image.length!==6)return;const q=Ee(C,M),ee=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+O);const Y=i.get(ee);if(ee.version!==Y.__version||q===!0){n.activeTexture(t.TEXTURE0+O);const ye=$e.getPrimaries($e.workingColorSpace),ae=M.colorSpace===Li?null:$e.getPrimaries(M.colorSpace),me=M.colorSpace===Li||ye===ae?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const Xe=M.isCompressedTexture||M.image[0].isCompressedTexture,ie=M.image[0]&&M.image[0].isDataTexture,ge=[];for(let K=0;K<6;K++)!Xe&&!ie?ge[K]=y(M.image[K],!0,r.maxCubemapSize):ge[K]=ie?M.image[K].image:M.image[K],ge[K]=it(M,ge[K]);const Re=ge[0],Pe=s.convert(M.format,M.colorSpace),_e=s.convert(M.type),Be=g(M.internalFormat,Pe,_e,M.colorSpace),De=M.isVideoTexture!==!0,tt=Y.__version===void 0||q===!0,D=ee.dataReady;let de=S(M,Re);se(t.TEXTURE_CUBE_MAP,M);let W;if(Xe){De&&tt&&n.texStorage2D(t.TEXTURE_CUBE_MAP,de,Be,Re.width,Re.height);for(let K=0;K<6;K++){W=ge[K].mipmaps;for(let ue=0;ue<W.length;ue++){const he=W[ue];M.format!==kn?Pe!==null?De?D&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,0,0,he.width,he.height,Pe,he.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,Be,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):De?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,0,0,he.width,he.height,Pe,_e,he.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue,Be,he.width,he.height,0,Pe,_e,he.data)}}}else{if(W=M.mipmaps,De&&tt){W.length>0&&de++;const K=be(ge[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,de,Be,K.width,K.height)}for(let K=0;K<6;K++)if(ie){De?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ge[K].width,ge[K].height,Pe,_e,ge[K].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Be,ge[K].width,ge[K].height,0,Pe,_e,ge[K].data);for(let ue=0;ue<W.length;ue++){const Ve=W[ue].image[K].image;De?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,0,0,Ve.width,Ve.height,Pe,_e,Ve.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,Be,Ve.width,Ve.height,0,Pe,_e,Ve.data)}}else{De?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Pe,_e,ge[K]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Be,Pe,_e,ge[K]);for(let ue=0;ue<W.length;ue++){const he=W[ue];De?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,0,0,Pe,_e,he.image[K]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ue+1,Be,Pe,_e,he.image[K])}}}p(M)&&c(t.TEXTURE_CUBE_MAP),Y.__version=ee.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function ne(C,M,O,q,ee,Y){const ye=s.convert(O.format,O.colorSpace),ae=s.convert(O.type),me=g(O.internalFormat,ye,ae,O.colorSpace);if(!i.get(M).__hasExternalTextures){const ie=Math.max(1,M.width>>Y),ge=Math.max(1,M.height>>Y);ee===t.TEXTURE_3D||ee===t.TEXTURE_2D_ARRAY?n.texImage3D(ee,Y,me,ie,ge,M.depth,0,ye,ae,null):n.texImage2D(ee,Y,me,ie,ge,0,ye,ae,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),We(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,q,ee,i.get(O).__webglTexture,0,ke(M)):(ee===t.TEXTURE_2D||ee>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,q,ee,i.get(O).__webglTexture,Y),n.bindFramebuffer(t.FRAMEBUFFER,null)}function fe(C,M,O){if(t.bindRenderbuffer(t.RENDERBUFFER,C),M.depthBuffer){const q=M.depthTexture,ee=q&&q.isDepthTexture?q.type:null,Y=_(M.stencilBuffer,ee),ye=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ae=ke(M);We(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ae,Y,M.width,M.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,ae,Y,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,Y,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,ye,t.RENDERBUFFER,C)}else{const q=M.textures;for(let ee=0;ee<q.length;ee++){const Y=q[ee],ye=s.convert(Y.format,Y.colorSpace),ae=s.convert(Y.type),me=g(Y.internalFormat,ye,ae,Y.colorSpace),Xe=ke(M);O&&We(M)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe,me,M.width,M.height):We(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Xe,me,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,me,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function le(C,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),j(M.depthTexture,0);const q=i.get(M.depthTexture).__webglTexture,ee=ke(M);if(M.depthTexture.format===ps)We(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,q,0,ee):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,q,0);else if(M.depthTexture.format===Cs)We(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,q,0,ee):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,q,0);else throw new Error("Unknown depthTexture format")}function Le(C){const M=i.get(C),O=C.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==C.depthTexture){const q=C.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),q){const ee=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,q.removeEventListener("dispose",ee)};q.addEventListener("dispose",ee),M.__depthDisposeCallback=ee}M.__boundDepthTexture=q}if(C.depthTexture&&!M.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");le(M.__webglFramebuffer,C)}else if(O){M.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[q]),M.__webglDepthbuffer[q]===void 0)M.__webglDepthbuffer[q]=t.createRenderbuffer(),fe(M.__webglDepthbuffer[q],C,!1);else{const ee=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Y=M.__webglDepthbuffer[q];t.bindRenderbuffer(t.RENDERBUFFER,Y),t.framebufferRenderbuffer(t.FRAMEBUFFER,ee,t.RENDERBUFFER,Y)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),fe(M.__webglDepthbuffer,C,!1);else{const q=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ee=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ee),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,ee)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function we(C,M,O){const q=i.get(C);M!==void 0&&ne(q.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),O!==void 0&&Le(C)}function ze(C){const M=C.texture,O=i.get(C),q=i.get(M);C.addEventListener("dispose",w);const ee=C.textures,Y=C.isWebGLCubeRenderTarget===!0,ye=ee.length>1;if(ye||(q.__webglTexture===void 0&&(q.__webglTexture=t.createTexture()),q.__version=M.version,o.memory.textures++),Y){O.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(M.mipmaps&&M.mipmaps.length>0){O.__webglFramebuffer[ae]=[];for(let me=0;me<M.mipmaps.length;me++)O.__webglFramebuffer[ae][me]=t.createFramebuffer()}else O.__webglFramebuffer[ae]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){O.__webglFramebuffer=[];for(let ae=0;ae<M.mipmaps.length;ae++)O.__webglFramebuffer[ae]=t.createFramebuffer()}else O.__webglFramebuffer=t.createFramebuffer();if(ye)for(let ae=0,me=ee.length;ae<me;ae++){const Xe=i.get(ee[ae]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=t.createTexture(),o.memory.textures++)}if(C.samples>0&&We(C)===!1){O.__webglMultisampledFramebuffer=t.createFramebuffer(),O.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ae=0;ae<ee.length;ae++){const me=ee[ae];O.__webglColorRenderbuffer[ae]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,O.__webglColorRenderbuffer[ae]);const Xe=s.convert(me.format,me.colorSpace),ie=s.convert(me.type),ge=g(me.internalFormat,Xe,ie,me.colorSpace,C.isXRRenderTarget===!0),Re=ke(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,Re,ge,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.RENDERBUFFER,O.__webglColorRenderbuffer[ae])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(O.__webglDepthRenderbuffer=t.createRenderbuffer(),fe(O.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(Y){n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture),se(t.TEXTURE_CUBE_MAP,M);for(let ae=0;ae<6;ae++)if(M.mipmaps&&M.mipmaps.length>0)for(let me=0;me<M.mipmaps.length;me++)ne(O.__webglFramebuffer[ae][me],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,me);else ne(O.__webglFramebuffer[ae],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);p(M)&&c(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ye){for(let ae=0,me=ee.length;ae<me;ae++){const Xe=ee[ae],ie=i.get(Xe);n.bindTexture(t.TEXTURE_2D,ie.__webglTexture),se(t.TEXTURE_2D,Xe),ne(O.__webglFramebuffer,C,Xe,t.COLOR_ATTACHMENT0+ae,t.TEXTURE_2D,0),p(Xe)&&c(t.TEXTURE_2D)}n.unbindTexture()}else{let ae=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ae=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ae,q.__webglTexture),se(ae,M),M.mipmaps&&M.mipmaps.length>0)for(let me=0;me<M.mipmaps.length;me++)ne(O.__webglFramebuffer[me],C,M,t.COLOR_ATTACHMENT0,ae,me);else ne(O.__webglFramebuffer,C,M,t.COLOR_ATTACHMENT0,ae,0);p(M)&&c(ae),n.unbindTexture()}C.depthBuffer&&Le(C)}function Je(C){const M=C.textures;for(let O=0,q=M.length;O<q;O++){const ee=M[O];if(p(ee)){const Y=C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,ye=i.get(ee).__webglTexture;n.bindTexture(Y,ye),c(Y),n.unbindTexture()}}}const He=[],b=[];function tn(C){if(C.samples>0){if(We(C)===!1){const M=C.textures,O=C.width,q=C.height;let ee=t.COLOR_BUFFER_BIT;const Y=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ye=i.get(C),ae=M.length>1;if(ae)for(let me=0;me<M.length;me++)n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let me=0;me<M.length;me++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(ee|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(ee|=t.STENCIL_BUFFER_BIT)),ae){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ye.__webglColorRenderbuffer[me]);const Xe=i.get(M[me]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Xe,0)}t.blitFramebuffer(0,0,O,q,0,0,O,q,ee,t.NEAREST),l===!0&&(He.length=0,b.length=0,He.push(t.COLOR_ATTACHMENT0+me),C.depthBuffer&&C.resolveDepthBuffer===!1&&(He.push(Y),b.push(Y),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,b)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,He))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ae)for(let me=0;me<M.length;me++){n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,ye.__webglColorRenderbuffer[me]);const Xe=i.get(M[me]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,Xe,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const M=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function ke(C){return Math.min(r.maxSamples,C.samples)}function We(C){const M=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ce(C){const M=o.render.frame;f.get(C)!==M&&(f.set(C,M),C.update())}function it(C,M){const O=C.colorSpace,q=C.format,ee=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||O!==Qi&&O!==Li&&($e.getTransfer(O)===ot?(q!==kn||ee!==mi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),M}function be(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(u.width=C.naturalWidth||C.width,u.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(u.width=C.displayWidth,u.height=C.displayHeight):(u.width=C.width,u.height=C.height),u}this.allocateTextureUnit=H,this.resetTextureUnits=T,this.setTexture2D=j,this.setTexture2DArray=Q,this.setTexture3D=G,this.setTextureCube=J,this.rebindTextures=we,this.setupRenderTarget=ze,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=tn,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=ne,this.useMultisampledRTT=We}function b1(t,e){function n(i,r=Li){let s;const o=$e.getTransfer(r);if(i===mi)return t.UNSIGNED_BYTE;if(i===Od)return t.UNSIGNED_SHORT_4_4_4_4;if(i===kd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===R_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===A_)return t.BYTE;if(i===C_)return t.SHORT;if(i===bo)return t.UNSIGNED_SHORT;if(i===Fd)return t.INT;if(i===Er)return t.UNSIGNED_INT;if(i===li)return t.FLOAT;if(i===Fo)return t.HALF_FLOAT;if(i===P_)return t.ALPHA;if(i===b_)return t.RGB;if(i===kn)return t.RGBA;if(i===L_)return t.LUMINANCE;if(i===D_)return t.LUMINANCE_ALPHA;if(i===ps)return t.DEPTH_COMPONENT;if(i===Cs)return t.DEPTH_STENCIL;if(i===I_)return t.RED;if(i===Bd)return t.RED_INTEGER;if(i===N_)return t.RG;if(i===zd)return t.RG_INTEGER;if(i===Hd)return t.RGBA_INTEGER;if(i===Wa||i===Xa||i===ja||i===Ya)if(o===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Wa)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Xa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ja)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ya)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Wa)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Xa)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ja)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ya)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===cf||i===ff||i===df||i===hf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===cf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===ff)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===df)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===hf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===pf||i===mf||i===gf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===pf||i===mf)return o===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===gf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===_f||i===vf||i===xf||i===yf||i===Sf||i===Mf||i===Ef||i===Tf||i===wf||i===Af||i===Cf||i===Rf||i===Pf||i===bf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===_f)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===vf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===xf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===yf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Sf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Mf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ef)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Tf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===wf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Af)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Cf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Rf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Pf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===bf)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===qa||i===Lf||i===Df)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===qa)return o===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Lf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Df)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===U_||i===If||i===Nf||i===Uf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===qa)return s.COMPRESSED_RED_RGTC1_EXT;if(i===If)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Nf)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Uf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===As?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class L1 extends ln{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Aa extends Gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const D1={type:"move"};class nc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Aa,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Aa,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Aa,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const y of e.hand.values()){const p=n.getJointPose(y,i),c=this._getHandJoint(u,y);p!==null&&(c.matrix.fromArray(p.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=p.radius),c.visible=p!==null}const f=u.joints["index-finger-tip"],h=u.joints["thumb-tip"],d=f.position.distanceTo(h.position),m=.02,x=.005;u.inputState.pinching&&d>m+x?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&d<=m-x&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(D1)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Aa;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const I1=`
void main() {
...
}`;class U1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new Vt,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new qi({vertexShader:I1,fragmentShader:N1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new cn(new ql(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class F1 extends Ds{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,f=null,h=null,d=null,m=null,x=null;const y=new U1,p=n.getContextAttributes();let c=null,g=null;const _=[],S=[],R=new Ue;let w=null;const A=new ln;A.layers.enable(1),A.viewport=new _t;const P=new ln;P.layers.enable(2),P.viewport=new _t;const V=[A,P],v=new L1;v.layers.enable(1),v.layers.enable(2);let T=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let ne=_[X];return ne===void 0&&(ne=new nc,_[X]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function(X){let ne=_[X];return ne===void 0&&(ne=new nc,_[X]=ne),ne.getGripSpace()},this.getHand=function(X){let ne=_[X];return ne===void 0&&(ne=new nc,_[X]=ne),ne.getHandSpace()};function F(X){const ne=S.indexOf(X.inputSource);if(ne===-1)return;const fe=_[ne];fe!==void 0&&(fe.update(X.inputSource,X.frame,u||o),fe.dispatchEvent({type:X.type,data:X.inputSource}))}function j(){r.removeEventListener("select",F),r.removeEventListener("selectstart",F),r.removeEventListener("selectend",F),r.removeEventListener("squeeze",F),r.removeEventListener("squeezestart",F),r.removeEventListener("squeezeend",F),r.removeEventListener("end",j),r.removeEventListener("inputsourceschange",Q);for(let X=0;X<_.length;X++){const ne=S[X];ne!==null&&(S[X]=null,_[X].disconnect(ne))}T=null,H=null,y.reset(),e.setRenderTarget(c),m=null,d=null,h=null,r=null,g=null,Oe.stop(),i.isPresenting=!1,e.setPixelRatio(w),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){s=X,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){a=X,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(X){u=X},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(c=e.getRenderTarget(),r.addEventListener("select",F),r.addEventListener("selectstart",F),r.addEventListener("selectend",F),r.addEventListener("squeeze",F),r.addEventListener("squeezestart",F),r.addEventListener("squeezeend",F),r.addEventListener("end",j),r.addEventListener("inputsourceschange",Q),p.xrCompatible!==!0&&await n.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(R),r.renderState.layers===void 0){const ne={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,ne),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),g=new Tr(m.framebufferWidth,m.framebufferHeight,{format:kn,type:mi,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}else{let ne=null,fe=null,le=null;p.depth&&(le=p.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ne=p.stencil?Cs:ps,fe=p.stencil?As:Er);const Le={colorFormat:n.RGBA8,depthFormat:le,scaleFactor:s};h=new XRWebGLBinding(r,n),d=h.createProjectionLayer(Le),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),g=new Tr(d.textureWidth,d.textureHeight,{format:kn,type:mi,depthTexture:new q_(d.textureWidth,d.textureHeight,fe,void 0,void 0,void 0,void 0,void 0,void 0,ne),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),Oe.setContext(r),Oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function Q(X){for(let ne=0;ne<X.removed.length;ne++){const fe=X.removed[ne],le=S.indexOf(fe);le>=0&&(S[le]=null,_[le].disconnect(fe))}for(let ne=0;ne<X.added.length;ne++){const fe=X.added[ne];let le=S.indexOf(fe);if(le===-1){for(let we=0;we<_.length;we++)if(we>=S.length){S.push(fe),le=we;break}else if(S[we]===null){S[we]=fe,le=we;break}if(le===-1)break}const Le=_[le];Le&&Le.connect(fe)}}const G=new U,J=new U;function L(X,ne,fe){G.setFromMatrixPosition(ne.matrixWorld),J.setFromMatrixPosition(fe.matrixWorld);const le=G.distanceTo(J),Le=ne.projectionMatrix.elements,we=fe.projectionMatrix.elements,ze=Le[14]/(Le[10]-1),Je=Le[14]/(Le[10]+1),He=(Le[9]+1)/Le[5],b=(Le[9]-1)/Le[5],tn=(Le[8]-1)/Le[0],ke=(we[8]+1)/we[0],We=ze*tn,Ce=ze*ke,it=le/(-tn+ke),be=it*-tn;if(ne.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(be),X.translateZ(it),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Le[10]===-1)X.projectionMatrix.copy(ne.projectionMatrix),X.projectionMatrixInverse.copy(ne.projectionMatrixInverse);else{const C=ze+it,M=Je+it,O=We-be,q=Ce+(le-be),ee=He*Je/M*C,Y=b*Je/M*C;X.projectionMatrix.makePerspective(O,q,ee,Y,C,M),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function $(X,ne){ne===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(ne.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;let ne=X.near,fe=X.far;y.texture!==null&&(y.depthNear>0&&(ne=y.depthNear),y.depthFar>0&&(fe=y.depthFar)),v.near=P.near=A.near=ne,v.far=P.far=A.far=fe,(T!==v.near||H!==v.far)&&(r.updateRenderState({depthNear:v.near,depthFar:v.far}),T=v.near,H=v.far);const le=X.parent,Le=v.cameras;$(v,le);for(let we=0;we<Le.length;we++)$(Le[we],le);Le.length===2?L(v,A,P):v.projectionMatrix.copy(A.projectionMatrix),Z(X,v,le)};function Z(X,ne,fe){fe===null?X.matrix.copy(ne.matrixWorld):(X.matrix.copy(fe.matrixWorld),X.matrix.invert(),X.matrix.multiply(ne.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(ne.projectionMatrix),X.projectionMatrixInverse.copy(ne.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Of*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(X){l=X,d!==null&&(d.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(v)};let se=null;function Ee(X,ne){if(f=ne.getViewerPose(u||o),x=ne,f!==null){const fe=f.views;m!==null&&(e.setRenderTargetFramebuffer(g,m.framebuffer),e.setRenderTarget(g));let le=!1;fe.length!==v.cameras.length&&(v.cameras.length=0,le=!0);for(let we=0;we<fe.length;we++){const ze=fe[we];let Je=null;if(m!==null)Je=m.getViewport(ze);else{const b=h.getViewSubImage(d,ze);Je=b.viewport,we===0&&(e.setRenderTargetTextures(g,b.colorTexture,d.ignoreDepthValues?void 0:b.depthStencilTexture),e.setRenderTarget(g))}let He=V[we];He===void 0&&(He=new ln,He.layers.enable(we),He.viewport=new _t,V[we]=He),He.matrix.fromArray(ze.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(ze.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(Je.x,Je.y,Je.width,Je.height),we===0&&(v.matrix.copy(He.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),le===!0&&v.cameras.push(He)}const Le=r.enabledFeatures;if(Le&&Le.includes("depth-sensing")){const we=h.getDepthInformation(fe[0]);we&&we.isValid&&we.texture&&y.init(e,we,r.renderState)}}for(let fe=0;fe<_.length;fe++){const le=S[fe],Le=_[fe];le!==null&&Le!==void 0&&Le.update(le,ne,u||o)}se&&se(X,ne),ne.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ne}),x=null}const Oe=new Y_;Oe.setAnimationLoop(Ee),this.setAnimationLoop=function(X){se=X},this.dispose=function(){}}}const sr=new gi,O1=new ft;function k1(t,e){function n(p,c){p.matrixAutoUpdate===!0&&p.updateMatrix(),c.value.copy(p.matrix)}function i(p,c){c.color.getRGB(p.fogColor.value,G_(t)),c.isFog?(p.fogNear.value=c.near,p.fogFar.value=c.far):c.isFogExp2&&(p.fogDensity.value=c.density)}function r(p,c,g,_,S){c.isMeshBasicMaterial||c.isMeshLambertMaterial?s(p,c):c.isMeshToonMaterial?(s(p,c),h(p,c)):c.isMeshPhongMaterial?(s(p,c),f(p,c)):c.isMeshStandardMaterial?(s(p,c),d(p,c),c.isMeshPhysicalMaterial&&m(p,c,S)):c.isMeshMatcapMaterial?(s(p,c),x(p,c)):c.isMeshDepthMaterial?s(p,c):c.isMeshDistanceMaterial?(s(p,c),y(p,c)):c.isMeshNormalMaterial?s(p,c):c.isLineBasicMaterial?(o(p,c),c.isLineDashedMaterial&&a(p,c)):c.isPointsMaterial?l(p,c,g,_):c.isSpriteMaterial?u(p,c):c.isShadowMaterial?(p.color.value.copy(c.color),p.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(p,c){p.opacity.value=c.opacity,c.color&&p.diffuse.value.copy(c.color),c.emissive&&p.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.bumpMap&&(p.bumpMap.value=c.bumpMap,n(c.bumpMap,p.bumpMapTransform),p.bumpScale.value=c.bumpScale,c.side===en&&(p.bumpScale.value*=-1)),c.normalMap&&(p.normalMap.value=c.normalMap,n(c.normalMap,p.normalMapTransform),p.normalScale.value.copy(c.normalScale),c.side===en&&p.normalScale.value.negate()),c.displacementMap&&(p.displacementMap.value=c.displacementMap,n(c.displacementMap,p.displacementMapTransform),p.displacementScale.value=c.displacementScale,p.displacementBias.value=c.displacementBias),c.emissiveMap&&(p.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,p.emissiveMapTransform)),c.specularMap&&(p.specularMap.value=c.specularMap,n(c.specularMap,p.specularMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest);const g=e.get(c),_=g.envMap,S=g.envMapRotation;_&&(p.envMap.value=_,sr.copy(S),sr.x*=-1,sr.y*=-1,sr.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(sr.y*=-1,sr.z*=-1),p.envMapRotation.value.setFromMatrix4(O1.makeRotationFromEuler(sr)),p.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=c.reflectivity,p.ior.value=c.ior,p.refractionRatio.value=c.refractionRatio),c.lightMap&&(p.lightMap.value=c.lightMap,p.lightMapIntensity.value=c.lightMapIntensity,n(c.lightMap,p.lightMapTransform)),c.aoMap&&(p.aoMap.value=c.aoMap,p.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,p.aoMapTransform))}function o(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform))}function a(p,c){p.dashSize.value=c.dashSize,p.totalSize.value=c.dashSize+c.gapSize,p.scale.value=c.scale}function l(p,c,g,_){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.size.value=c.size*g,p.scale.value=_*.5,c.map&&(p.map.value=c.map,n(c.map,p.uvTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function u(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.rotation.value=c.rotation,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function f(p,c){p.specular.value.copy(c.specular),p.shininess.value=Math.max(c.shininess,1e-4)}function h(p,c){c.gradientMap&&(p.gradientMap.value=c.gradientMap)}function d(p,c){p.metalness.value=c.metalness,c.metalnessMap&&(p.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,p.metalnessMapTransform)),p.roughness.value=c.roughness,c.roughnessMap&&(p.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,p.roughnessMapTransform)),c.envMap&&(p.envMapIntensity.value=c.envMapIntensity)}function m(p,c,g){p.ior.value=c.ior,c.sheen>0&&(p.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),p.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(p.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,p.sheenColorMapTransform)),c.sheenRoughnessMap&&(p.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,p.sheenRoughnessMapTransform))),c.clearcoat>0&&(p.clearcoat.value=c.clearcoat,p.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(p.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,p.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(p.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===en&&p.clearcoatNormalScale.value.negate())),c.dispersion>0&&(p.dispersion.value=c.dispersion),c.iridescence>0&&(p.iridescence.value=c.iridescence,p.iridescenceIOR.value=c.iridescenceIOR,p.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(p.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,p.iridescenceMapTransform)),c.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),c.transmission>0&&(p.transmission.value=c.transmission,p.transmissionSamplerMap.value=g.texture,p.transmissionSamplerSize.value.set(g.width,g.height),c.transmissionMap&&(p.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,p.transmissionMapTransform)),p.thickness.value=c.thickness,c.thicknessMap&&(p.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=c.attenuationDistance,p.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(p.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(p.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=c.specularIntensity,p.specularColor.value.copy(c.specularColor),c.specularColorMap&&(p.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,p.specularColorMapTransform)),c.specularIntensityMap&&(p.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,c){c.matcap&&(p.matcap.value=c.matcap)}function y(p,c){const g=e.get(c).light;p.referencePosition.value.setFromMatrixPosition(g.matrixWorld),p.nearDistance.value=g.shadow.camera.near,p.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function B1(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,_){const S=_.program;i.uniformBlockBinding(g,S)}function u(g,_){let S=r[g.id];S===void 0&&(x(g),S=f(g),r[g.id]=S,g.addEventListener("dispose",p));const R=_.program;i.updateUBOMapping(g,R);const w=e.render.frame;s[g.id]!==w&&(d(g),s[g.id]=w)}function f(g){const _=h();g.__bindingPointIndex=_;const S=t.createBuffer(),R=g.__size,w=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,S),t.bufferData(t.UNIFORM_BUFFER,R,w),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,S),S}function h(){for(let g=0;g<a;g++)if(o.indexOf(g)===-1)return o.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(g){const _=r[g.id],S=g.uniforms,R=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let w=0,A=S.length;w<A;w++){const P=Array.isArray(S[w])?S[w]:[S[w]];for(let V=0,v=P.length;V<v;V++){const T=P[V];if(m(T,w,V,R)===!0){const H=T.__offset,F=Array.isArray(T.value)?T.value:[T.value];let j=0;for(let Q=0;Q<F.length;Q++){const G=F[Q],J=y(G);typeof G=="number"||typeof G=="boolean"?(T.__data[0]=G,t.bufferSubData(t.UNIFORM_BUFFER,H+j,T.__data)):G.isMatrix3?(T.__data[0]=G.elements[0],T.__data[1]=G.elements[1],T.__data[2]=G.elements[2],T.__data[3]=0,T.__data[4]=G.elements[3],T.__data[5]=G.elements[4],T.__data[6]=G.elements[5],T.__data[7]=0,T.__data[8]=G.elements[6],T.__data[9]=G.elements[7],T.__data[10]=G.elements[8],T.__data[11]=0):(G.toArray(T.__data,j),j+=J.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,H,T.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(g,_,S,R){const w=g.value,A=_+"_"+S;if(R[A]===void 0)return typeof w=="number"||typeof w=="boolean"?R[A]=w:R[A]=w.clone(),!0;{const P=R[A];if(typeof w=="number"||typeof w=="boolean"){if(P!==w)return R[A]=w,!0}else if(P.equals(w)===!1)return P.copy(w),!0}return!1}function x(g){const _=g.uniforms;let S=0;const R=16;for(let A=0,P=_.length;A<P;A++){const V=Array.isArray(_[A])?_[A]:[_[A]];for(let v=0,T=V.length;v<T;v++){const H=V[v],F=Array.isArray(H.value)?H.value:[H.value];for(let j=0,Q=F.length;j<Q;j++){const G=F[j],J=y(G),L=S%R,$=L%J.boundary,Z=L+$;S+=$,Z!==0&&R-Z<J.storage&&(S+=R-Z),H.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=S,S+=J.storage}}}const w=S%R;return w>0&&(S+=R-w),g.__size=S,g.__cache={},this}function y(g){const _={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(_.boundary=4,_.storage=4):g.isVector2?(_.boundary=8,_.storage=8):g.isVector3||g.isColor?(_.boundary=16,_.storage=12):g.isVector4?(_.boundary=16,_.storage=16):g.isMatrix3?(_.boundary=48,_.storage=48):g.isMatrix4?(_.boundary=64,_.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),_}function p(g){const _=g.target;_.removeEventListener("dispose",p);const S=o.indexOf(_.__bindingPointIndex);o.splice(S,1),t.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function c(){for(const g in r)t.deleteBuffer(r[g]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}class J_{constructor(e={}){const{canvas:n=Ay(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=o;const m=new Uint32Array(4),x=new Int32Array(4);let y=null,p=null;const c=[],g=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Wn,this.toneMapping=Gi,this.toneMappingExposure=1;const _=this;let S=!1,R=0,w=0,A=null,P=-1,V=null;const v=new _t,T=new _t;let H=null;const F=new Ke(0);let j=0,Q=n.width,G=n.height,J=1,L=null,$=null;const Z=new _t(0,0,Q,G),se=new _t(0,0,Q,G);let Ee=!1;const Oe=new j_;let X=!1,ne=!1;const fe=new ft,le=new ft,Le=new U,we=new _t,ze={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Je=!1;function He(){return A===null?J:1}let b=i;function tn(E,I){return n.getContext(E,I)}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Ud}`),n.addEventListener("webglcontextlost",K,!1),n.addEventListener("webglcontextrestored",ue,!1),n.addEventListener("webglcontextcreationerror",he,!1),b===null){const I="webgl2";if(b=tn(I,E),b===null)throw tn(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let ke,We,Ce,it,be,C,M,O,q,ee,Y,ye,ae,me,Xe,ie,ge,Re,Pe,_e,Be,De,tt,D;function de(){ke=new XE(b),ke.init(),De=new b1(b,ke),We=new kE(b,ke,e,De),Ce=new C1(b),We.reverseDepthBuffer&&Ce.buffers.depth.setReversed(!0),it=new qE(b),be=new d1,C=new P1(b,ke,Ce,be,We,De,it),M=new zE(_),O=new WE(_),q=new eS(b),tt=new FE(b,q),ee=new jE(b,q,it,tt),Y=new KE(b,ee,q,it),Pe=new $E(b,We,C),ie=new BE(be),ye=new f1(_,M,O,ke,We,tt,ie),ae=new k1(_,be),me=new p1,Xe=new y1(ke),Re=new UE(_,M,O,Ce,Y,d,l),ge=new w1(_,Y,We),D=new B1(b,it,We,Ce),_e=new OE(b,ke,it),Be=new YE(b,ke,it),it.programs=ye.programs,_.capabilities=We,_.extensions=ke,_.properties=be,_.renderLists=me,_.shadowMap=ge,_.state=Ce,_.info=it}de();const W=new F1(_,b);this.xr=W,this.getContext=function(){return b},this.getContextAttributes=function(){return b.getContextAttributes()},this.forceContextLoss=function(){const E=ke.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=ke.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(E){E!==void 0&&(J=E,this.setSize(Q,G,!1))},this.getSize=function(E){return E.set(Q,G)},this.setSize=function(E,I,B=!0){if(W.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Q=E,G=I,n.width=Math.floor(E*J),n.height=Math.floor(I*J),B===!0&&(n.style.width=E+"px",n.style.height=I+"px"),this.setViewport(0,0,E,I)},this.getDrawingBufferSize=function(E){return E.set(Q*J,G*J).floor()},this.setDrawingBufferSize=function(E,I,B){Q=E,G=I,J=B,n.width=Math.floor(E*B),n.height=Math.floor(I*B),this.setViewport(0,0,E,I)},this.getCurrentViewport=function(E){return E.copy(v)},this.getViewport=function(E){return E.copy(Z)},this.setViewport=function(E,I,B,z){E.isVector4?Z.set(E.x,E.y,E.z,E.w):Z.set(E,I,B,z),Ce.viewport(v.copy(Z).multiplyScalar(J).round())},this.getScissor=function(E){return E.copy(se)},this.setScissor=function(E,I,B,z){E.isVector4?se.set(E.x,E.y,E.z,E.w):se.set(E,I,B,z),Ce.scissor(T.copy(se).multiplyScalar(J).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(E){Ce.setScissorTest(Ee=E)},this.setOpaqueSort=function(E){L=E},this.setTransparentSort=function(E){$=E},this.getClearColor=function(E){return E.copy(Re.getClearColor())},this.setClearColor=function(){Re.setClearColor.apply(Re,arguments)},this.getClearAlpha=function(){return Re.getClearAlpha()},this.setClearAlpha=function(){Re.setClearAlpha.apply(Re,arguments)},this.clear=function(E=!0,I=!0,B=!0){let z=0;if(E){let N=!1;if(A!==null){const re=A.texture.format;N=re===Hd||re===zd||re===Bd}if(N){const re=A.texture.type,ce=re===mi||re===Er||re===bo||re===As||re===Od||re===kd,ve=Re.getClearColor(),xe=Re.getClearAlpha(),Te=ve.r,Ae=ve.g,Se=ve.b;ce?(m[0]=Te,m[1]=Ae,m[2]=Se,m[3]=xe,b.clearBufferuiv(b.COLOR,0,m)):(x[0]=Te,x[1]=Ae,x[2]=Se,x[3]=xe,b.clearBufferiv(b.COLOR,0,x))}else z|=b.COLOR_BUFFER_BIT}I&&(z|=b.DEPTH_BUFFER_BIT,b.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),B&&(z|=b.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),b.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",K,!1),n.removeEventListener("webglcontextrestored",ue,!1),n.removeEventListener("webglcontextcreationerror",he,!1),me.dispose(),Xe.dispose(),be.dispose(),M.dispose(),O.dispose(),Y.dispose(),tt.dispose(),D.dispose(),ye.dispose(),W.dispose(),W.removeEventListener("sessionstart",Yd),W.removeEventListener("sessionend",qd),Ji.stop()};function K(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),S=!0}function ue(){console.log("THREE.WebGLRenderer: Context Restored."),S=!1;const E=it.autoReset,I=ge.enabled,B=ge.autoUpdate,z=ge.needsUpdate,N=ge.type;de(),it.autoReset=E,ge.enabled=I,ge.autoUpdate=B,ge.needsUpdate=z,ge.type=N}function he(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function Ve(E){const I=E.target;I.removeEventListener("dispose",Ve),vt(I)}function vt(E){jt(E),be.remove(E)}function jt(E){const I=be.get(E).programs;I!==void 0&&(I.forEach(function(B){ye.releaseProgram(B)}),E.isShaderMaterial&&ye.releaseShaderCache(E))}this.renderBufferDirect=function(E,I,B,z,N,re){I===null&&(I=ze);const ce=N.isMesh&&N.matrixWorld.determinant()<0,ve=ov(E,I,B,z,N);Ce.setMaterial(z,ce);let xe=B.index,Te=1;if(z.wireframe===!0){if(xe=ee.getWireframeAttribute(B),xe===void 0)return;Te=2}const Ae=B.drawRange,Se=B.attributes.position;let Ze=Ae.start*Te,rt=(Ae.start+Ae.count)*Te;re!==null&&(Ze=Math.max(Ze,re.start*Te),rt=Math.min(rt,(re.start+re.count)*Te)),xe!==null?(Ze=Math.max(Ze,0),rt=Math.min(rt,xe.count)):Se!=null&&(Ze=Math.max(Ze,0),rt=Math.min(rt,Se.count));const ht=rt-Ze;if(ht<0||ht===1/0)return;tt.setup(N,z,ve,B,xe);let nn,Ye=_e;if(xe!==null&&(nn=q.get(xe),Ye=Be,Ye.setIndex(nn)),N.isMesh)z.wireframe===!0?(Ce.setLineWidth(z.wireframeLinewidth*He()),Ye.setMode(b.LINES)):Ye.setMode(b.TRIANGLES);else if(N.isLine){let Me=z.linewidth;Me===void 0&&(Me=1),Ce.setLineWidth(Me*He()),N.isLineSegments?Ye.setMode(b.LINES):N.isLineLoop?Ye.setMode(b.LINE_LOOP):Ye.setMode(b.LINE_STRIP)}else N.isPoints?Ye.setMode(b.POINTS):N.isSprite&&Ye.setMode(b.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Ye.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(ke.get("WEBGL_multi_draw"))Ye.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Me=N._multiDrawStarts,Rt=N._multiDrawCounts,qe=N._multiDrawCount,Pn=xe?q.get(xe).bytesPerElement:1,Cr=be.get(z).currentProgram.getUniforms();for(let rn=0;rn<qe;rn++)Cr.setValue(b,"_gl_DrawID",rn),Ye.render(Me[rn]/Pn,Rt[rn])}else if(N.isInstancedMesh)Ye.renderInstances(Ze,ht,N.count);else if(B.isInstancedBufferGeometry){const Me=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,Rt=Math.min(B.instanceCount,Me);Ye.renderInstances(Ze,ht,Rt)}else Ye.render(Ze,ht)};function je(E,I,B){E.transparent===!0&&E.side===si&&E.forceSinglePass===!1?(E.side=en,E.needsUpdate=!0,Ho(E,I,B),E.side=Yi,E.needsUpdate=!0,Ho(E,I,B),E.side=si):Ho(E,I,B)}this.compile=function(E,I,B=null){B===null&&(B=E),p=Xe.get(B),p.init(I),g.push(p),B.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(p.pushLight(N),N.castShadow&&p.pushShadow(N))}),E!==B&&E.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(p.pushLight(N),N.castShadow&&p.pushShadow(N))}),p.setupLights();const z=new Set;return E.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const re=N.material;if(re)if(Array.isArray(re))for(let ce=0;ce<re.length;ce++){const ve=re[ce];je(ve,B,N),z.add(ve)}else je(re,B,N),z.add(re)}),g.pop(),p=null,z},this.compileAsync=function(E,I,B=null){const z=this.compile(E,I,B);return new Promise(N=>{function re(){if(z.forEach(function(ce){be.get(ce).currentProgram.isReady()&&z.delete(ce)}),z.size===0){N(E);return}setTimeout(re,10)}ke.get("KHR_parallel_shader_compile")!==null?re():setTimeout(re,10)})};let Yt=null;function Kn(E){Yt&&Yt(E)}function Yd(){Ji.stop()}function qd(){Ji.start()}const Ji=new Y_;Ji.setAnimationLoop(Kn),typeof self<"u"&&Ji.setContext(self),this.setAnimationLoop=function(E){Yt=E,W.setAnimationLoop(E),E===null?Ji.stop():Ji.start()},W.addEventListener("sessionstart",Yd),W.addEventListener("sessionend",qd),this.render=function(E,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(W.cameraAutoUpdate===!0&&W.updateCamera(I),I=W.getCamera()),E.isScene===!0&&E.onBeforeRender(_,E,I,A),p=Xe.get(E,g.length),p.init(I),g.push(p),le.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),Oe.setFromProjectionMatrix(le),ne=this.localClippingEnabled,X=ie.init(this.clippingPlanes,ne),y=me.get(E,c.length),y.init(),c.push(y),W.enabled===!0&&W.isPresenting===!0){const re=_.xr.getDepthSensingMesh();re!==null&&Kl(re,I,-1/0,_.sortObjects)}Kl(E,I,0,_.sortObjects),y.finish(),_.sortObjects===!0&&y.sort(L,$),Je=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Je&&Re.addToRenderList(y,E),this.info.render.frame++,X===!0&&ie.beginShadows();const B=p.state.shadowsArray;ge.render(B,E,I),X===!0&&ie.endShadows(),this.info.autoReset===!0&&this.info.reset();const z=y.opaque,N=y.transmissive;if(p.setupLights(),I.isArrayCamera){const re=I.cameras;if(N.length>0)for(let ce=0,ve=re.length;ce<ve;ce++){const xe=re[ce];Kd(z,N,E,xe)}Je&&Re.render(E);for(let ce=0,ve=re.length;ce<ve;ce++){const xe=re[ce];$d(y,E,xe,xe.viewport)}}else N.length>0&&Kd(z,N,E,I),Je&&Re.render(E),$d(y,E,I);A!==null&&(C.updateMultisampleRenderTarget(A),C.updateRenderTargetMipmap(A)),E.isScene===!0&&E.onAfterRender(_,E,I),tt.resetDefaultState(),P=-1,V=null,g.pop(),g.length>0?(p=g[g.length-1],X===!0&&ie.setGlobalState(_.clippingPlanes,p.state.camera)):p=null,c.pop(),c.length>0?y=c[c.length-1]:y=null};function Kl(E,I,B,z){if(E.visible===!1)return;if(E.layers.test(I.layers)){if(E.isGroup)B=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(I);else if(E.isLight)p.pushLight(E),E.castShadow&&p.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Oe.intersectsSprite(E)){z&&we.setFromMatrixPosition(E.matrixWorld).applyMatrix4(le);const ce=Y.update(E),ve=E.material;ve.visible&&y.push(E,ce,ve,B,we.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Oe.intersectsObject(E))){const ce=Y.update(E),ve=E.material;if(z&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),we.copy(E.boundingSphere.center)):(ce.boundingSphere===null&&ce.computeBoundingSphere(),we.copy(ce.boundingSphere.center)),we.applyMatrix4(E.matrixWorld).applyMatrix4(le)),Array.isArray(ve)){const xe=ce.groups;for(let Te=0,Ae=xe.length;Te<Ae;Te++){const Se=xe[Te],Ze=ve[Se.materialIndex];Ze&&Ze.visible&&y.push(E,ce,Ze,B,we.z,Se)}}else ve.visible&&y.push(E,ce,ve,B,we.z,null)}}const re=E.children;for(let ce=0,ve=re.length;ce<ve;ce++)Kl(re[ce],I,B,z)}function $d(E,I,B,z){const N=E.opaque,re=E.transmissive,ce=E.transparent;p.setupLightsView(B),X===!0&&ie.setGlobalState(_.clippingPlanes,B),z&&Ce.viewport(v.copy(z)),N.length>0&&zo(N,I,B),re.length>0&&zo(re,I,B),ce.length>0&&zo(ce,I,B),Ce.buffers.depth.setTest(!0),Ce.buffers.depth.setMask(!0),Ce.buffers.color.setMask(!0),Ce.setPolygonOffset(!1)}function Kd(E,I,B,z){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[z.id]===void 0&&(p.state.transmissionRenderTarget[z.id]=new Tr(1,1,{generateMipmaps:!0,type:ke.has("EXT_color_buffer_half_float")||ke.has("EXT_color_buffer_float")?Fo:mi,minFilter:mr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$e.workingColorSpace}));const re=p.state.transmissionRenderTarget[z.id],ce=z.viewport||v;re.setSize(ce.z,ce.w);const ve=_.getRenderTarget();_.setRenderTarget(re),_.getClearColor(F),j=_.getClearAlpha(),j<1&&_.setClearColor(16777215,.5),_.clear(),Je&&Re.render(B);const xe=_.toneMapping;_.toneMapping=Gi;const Te=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),p.setupLightsView(z),X===!0&&ie.setGlobalState(_.clippingPlanes,z),zo(E,B,z),C.updateMultisampleRenderTarget(re),C.updateRenderTargetMipmap(re),ke.has("WEBGL_multisampled_render_to_texture")===!1){let Ae=!1;for(let Se=0,Ze=I.length;Se<Ze;Se++){const rt=I[Se],ht=rt.object,nn=rt.geometry,Ye=rt.material,Me=rt.group;if(Ye.side===si&&ht.layers.test(z.layers)){const Rt=Ye.side;Ye.side=en,Ye.needsUpdate=!0,Zd(ht,B,z,nn,Ye,Me),Ye.side=Rt,Ye.needsUpdate=!0,Ae=!0}}Ae===!0&&(C.updateMultisampleRenderTarget(re),C.updateRenderTargetMipmap(re))}_.setRenderTarget(ve),_.setClearColor(F,j),Te!==void 0&&(z.viewport=Te),_.toneMapping=xe}function zo(E,I,B){const z=I.isScene===!0?I.overrideMaterial:null;for(let N=0,re=E.length;N<re;N++){const ce=E[N],ve=ce.object,xe=ce.geometry,Te=z===null?ce.material:z,Ae=ce.group;ve.layers.test(B.layers)&&Zd(ve,I,B,xe,Te,Ae)}}function Zd(E,I,B,z,N,re){E.onBeforeRender(_,I,B,z,N,re),E.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),N.onBeforeRender(_,I,B,z,E,re),N.transparent===!0&&N.side===si&&N.forceSinglePass===!1?(N.side=en,N.needsUpdate=!0,_.renderBufferDirect(B,I,z,N,E,re),N.side=Yi,N.needsUpdate=!0,_.renderBufferDirect(B,I,z,N,E,re),N.side=si):_.renderBufferDirect(B,I,z,N,E,re),E.onAfterRender(_,I,B,z,N,re)}function Ho(E,I,B){I.isScene!==!0&&(I=ze);const z=be.get(E),N=p.state.lights,re=p.state.shadowsArray,ce=N.state.version,ve=ye.getParameters(E,N.state,re,I,B),xe=ye.getProgramCacheKey(ve);let Te=z.programs;z.environment=E.isMeshStandardMaterial?I.environment:null,z.fog=I.fog,z.envMap=(E.isMeshStandardMaterial?O:M).get(E.envMap||z.environment),z.envMapRotation=z.environment!==null&&E.envMap===null?I.environmentRotation:E.envMapRotation,Te===void 0&&(E.addEventListener("dispose",Ve),Te=new Map,z.programs=Te);let Ae=Te.get(xe);if(Ae!==void 0){if(z.currentProgram===Ae&&z.lightsStateVersion===ce)return Jd(E,ve),Ae}else ve.uniforms=ye.getUniforms(E),E.onBeforeCompile(ve,_),Ae=ye.acquireProgram(ve,xe),Te.set(xe,Ae),z.uniforms=ve.uniforms;const Se=z.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Se.clippingPlanes=ie.uniform),Jd(E,ve),z.needsLights=lv(E),z.lightsStateVersion=ce,z.needsLights&&(Se.ambientLightColor.value=N.state.ambient,Se.lightProbe.value=N.state.probe,Se.directionalLights.value=N.state.directional,Se.directionalLightShadows.value=N.state.directionalShadow,Se.spotLights.value=N.state.spot,Se.spotLightShadows.value=N.state.spotShadow,Se.rectAreaLights.value=N.state.rectArea,Se.ltc_1.value=N.state.rectAreaLTC1,Se.ltc_2.value=N.state.rectAreaLTC2,Se.pointLights.value=N.state.point,Se.pointLightShadows.value=N.state.pointShadow,Se.hemisphereLights.value=N.state.hemi,Se.directionalShadowMap.value=N.state.directionalShadowMap,Se.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Se.spotShadowMap.value=N.state.spotShadowMap,Se.spotLightMatrix.value=N.state.spotLightMatrix,Se.spotLightMap.value=N.state.spotLightMap,Se.pointShadowMap.value=N.state.pointShadowMap,Se.pointShadowMatrix.value=N.state.pointShadowMatrix),z.currentProgram=Ae,z.uniformsList=null,Ae}function Qd(E){if(E.uniformsList===null){const I=E.currentProgram.getUniforms();E.uniformsList=Ka.seqWithValue(I.seq,E.uniforms)}return E.uniformsList}function Jd(E,I){const B=be.get(E);B.outputColorSpace=I.outputColorSpace,B.batching=I.batching,B.batchingColor=I.batchingColor,B.instancing=I.instancing,B.instancingColor=I.instancingColor,B.instancingMorph=I.instancingMorph,B.skinning=I.skinning,B.morphTargets=I.morphTargets,B.morphNormals=I.morphNormals,B.morphColors=I.morphColors,B.morphTargetsCount=I.morphTargetsCount,B.numClippingPlanes=I.numClippingPlanes,B.numIntersection=I.numClipIntersection,B.vertexAlphas=I.vertexAlphas,B.vertexTangents=I.vertexTangents,B.toneMapping=I.toneMapping}function ov(E,I,B,z,N){I.isScene!==!0&&(I=ze),C.resetTextureUnits();const re=I.fog,ce=z.isMeshStandardMaterial?I.environment:null,ve=A===null?_.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:Qi,xe=(z.isMeshStandardMaterial?O:M).get(z.envMap||ce),Te=z.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Ae=!!B.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),Se=!!B.morphAttributes.position,Ze=!!B.morphAttributes.normal,rt=!!B.morphAttributes.color;let ht=Gi;z.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(ht=_.toneMapping);const nn=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,Ye=nn!==void 0?nn.length:0,Me=be.get(z),Rt=p.state.lights;if(X===!0&&(ne===!0||E!==V)){const vn=E===V&&z.id===P;ie.setState(z,E,vn)}let qe=!1;z.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==Rt.state.version||Me.outputColorSpace!==ve||N.isBatchedMesh&&Me.batching===!1||!N.isBatchedMesh&&Me.batching===!0||N.isBatchedMesh&&Me.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Me.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Me.instancing===!1||!N.isInstancedMesh&&Me.instancing===!0||N.isSkinnedMesh&&Me.skinning===!1||!N.isSkinnedMesh&&Me.skinning===!0||N.isInstancedMesh&&Me.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Me.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Me.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Me.instancingMorph===!1&&N.morphTexture!==null||Me.envMap!==xe||z.fog===!0&&Me.fog!==re||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==ie.numPlanes||Me.numIntersection!==ie.numIntersection)||Me.vertexAlphas!==Te||Me.vertexTangents!==Ae||Me.morphTargets!==Se||Me.morphNormals!==Ze||Me.morphColors!==rt||Me.toneMapping!==ht||Me.morphTargetsCount!==Ye)&&(qe=!0):(qe=!0,Me.__version=z.version);let Pn=Me.currentProgram;qe===!0&&(Pn=Ho(z,I,N));let Cr=!1,rn=!1,Zl=!1;const mt=Pn.getUniforms(),vi=Me.uniforms;if(Ce.useProgram(Pn.program)&&(Cr=!0,rn=!0,Zl=!0),z.id!==P&&(P=z.id,rn=!0),Cr||V!==E){We.reverseDepthBuffer?(fe.copy(E.projectionMatrix),Ry(fe),Py(fe),mt.setValue(b,"projectionMatrix",fe)):mt.setValue(b,"projectionMatrix",E.projectionMatrix),mt.setValue(b,"viewMatrix",E.matrixWorldInverse);const vn=mt.map.cameraPosition;vn!==void 0&&vn.setValue(b,Le.setFromMatrixPosition(E.matrixWorld)),We.logarithmicDepthBuffer&&mt.setValue(b,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&mt.setValue(b,"isOrthographic",E.isOrthographicCamera===!0),V!==E&&(V=E,rn=!0,Zl=!0)}if(N.isSkinnedMesh){mt.setOptional(b,N,"bindMatrix"),mt.setOptional(b,N,"bindMatrixInverse");const vn=N.skeleton;vn&&(vn.boneTexture===null&&vn.computeBoneTexture(),mt.setValue(b,"boneTexture",vn.boneTexture,C))}N.isBatchedMesh&&(mt.setOptional(b,N,"batchingTexture"),mt.setValue(b,"batchingTexture",N._matricesTexture,C),mt.setOptional(b,N,"batchingIdTexture"),mt.setValue(b,"batchingIdTexture",N._indirectTexture,C),mt.setOptional(b,N,"batchingColorTexture"),N._colorsTexture!==null&&mt.setValue(b,"batchingColorTexture",N._colorsTexture,C));const Ql=B.morphAttributes;if((Ql.position!==void 0||Ql.normal!==void 0||Ql.color!==void 0)&&Pe.update(N,B,Pn),(rn||Me.receiveShadow!==N.receiveShadow)&&(Me.receiveShadow=N.receiveShadow,mt.setValue(b,"receiveShadow",N.receiveShadow)),z.isMeshGouraudMaterial&&z.envMap!==null&&(vi.envMap.value=xe,vi.flipEnvMap.value=xe.isCubeTexture&&xe.isRenderTargetTexture===!1?-1:1),z.isMeshStandardMaterial&&z.envMap===null&&I.environment!==null&&(vi.envMapIntensity.value=I.environmentIntensity),rn&&(mt.setValue(b,"toneMappingExposure",_.toneMappingExposure),Me.needsLights&&av(vi,Zl),re&&z.fog===!0&&ae.refreshFogUniforms(vi,re),ae.refreshMaterialUniforms(vi,z,J,G,p.state.transmissionRenderTarget[E.id]),Ka.upload(b,Qd(Me),vi,C)),z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(Ka.upload(b,Qd(Me),vi,C),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&mt.setValue(b,"center",N.center),mt.setValue(b,"modelViewMatrix",N.modelViewMatrix),mt.setValue(b,"normalMatrix",N.normalMatrix),mt.setValue(b,"modelMatrix",N.matrixWorld),z.isShaderMaterial||z.isRawShaderMaterial){const vn=z.uniformsGroups;for(let Jl=0,uv=vn.length;Jl<uv;Jl++){const eh=vn[Jl];D.update(eh,Pn),D.bind(eh,Pn)}}return Pn}function av(E,I){E.ambientLightColor.needsUpdate=I,E.lightProbe.needsUpdate=I,E.directionalLights.needsUpdate=I,E.directionalLightShadows.needsUpdate=I,E.pointLights.needsUpdate=I,E.pointLightShadows.needsUpdate=I,E.spotLights.needsUpdate=I,E.spotLightShadows.needsUpdate=I,E.rectAreaLights.needsUpdate=I,E.hemisphereLights.needsUpdate=I}function lv(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(E,I,B){be.get(E.texture).__webglTexture=I,be.get(E.depthTexture).__webglTexture=B;const z=be.get(E);z.__hasExternalTextures=!0,z.__autoAllocateDepthBuffer=B===void 0,z.__autoAllocateDepthBuffer||ke.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),z.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(E,I){const B=be.get(E);B.__webglFramebuffer=I,B.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(E,I=0,B=0){A=E,R=I,w=B;let z=!0,N=null,re=!1,ce=!1;if(E){const xe=be.get(E);if(xe.__useDefaultFramebuffer!==void 0)Ce.bindFramebuffer(b.FRAMEBUFFER,null),z=!1;else if(xe.__webglFramebuffer===void 0)C.setupRenderTarget(E);else if(xe.__hasExternalTextures)C.rebindTextures(E,be.get(E.texture).__webglTexture,be.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Se=E.depthTexture;if(xe.__boundDepthTexture!==Se){if(Se!==null&&be.has(Se)&&(E.width!==Se.image.width||E.height!==Se.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");C.setupDepthRenderbuffer(E)}}const Te=E.texture;(Te.isData3DTexture||Te.isDataArrayTexture||Te.isCompressedArrayTexture)&&(ce=!0);const Ae=be.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Ae[I])?N=Ae[I][B]:N=Ae[I],re=!0):E.samples>0&&C.useMultisampledRTT(E)===!1?N=be.get(E).__webglMultisampledFramebuffer:Array.isArray(Ae)?N=Ae[B]:N=Ae,v.copy(E.viewport),T.copy(E.scissor),H=E.scissorTest}else v.copy(Z).multiplyScalar(J).floor(),T.copy(se).multiplyScalar(J).floor(),H=Ee;if(Ce.bindFramebuffer(b.FRAMEBUFFER,N)&&z&&Ce.drawBuffers(E,N),Ce.viewport(v),Ce.scissor(T),Ce.setScissorTest(H),re){const xe=be.get(E.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_CUBE_MAP_POSITIVE_X+I,xe.__webglTexture,B)}else if(ce){const xe=be.get(E.texture),Te=I||0;b.framebufferTextureLayer(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,xe.__webglTexture,B||0,Te)}P=-1},this.readRenderTargetPixels=function(E,I,B,z,N,re,ce){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=be.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ce!==void 0&&(ve=ve[ce]),ve){Ce.bindFramebuffer(b.FRAMEBUFFER,ve);try{const xe=E.texture,Te=xe.format,Ae=xe.type;if(!We.textureFormatReadable(Te)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!We.textureTypeReadable(Ae)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=E.width-z&&B>=0&&B<=E.height-N&&b.readPixels(I,B,z,N,De.convert(Te),De.convert(Ae),re)}finally{const xe=A!==null?be.get(A).__webglFramebuffer:null;Ce.bindFramebuffer(b.FRAMEBUFFER,xe)}}},this.readRenderTargetPixelsAsync=async function(E,I,B,z,N,re,ce){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=be.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ce!==void 0&&(ve=ve[ce]),ve){const xe=E.texture,Te=xe.format,Ae=xe.type;if(!We.textureFormatReadable(Te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!We.textureTypeReadable(Ae))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(I>=0&&I<=E.width-z&&B>=0&&B<=E.height-N){Ce.bindFramebuffer(b.FRAMEBUFFER,ve);const Se=b.createBuffer();b.bindBuffer(b.PIXEL_PACK_BUFFER,Se),b.bufferData(b.PIXEL_PACK_BUFFER,re.byteLength,b.STREAM_READ),b.readPixels(I,B,z,N,De.convert(Te),De.convert(Ae),0);const Ze=A!==null?be.get(A).__webglFramebuffer:null;Ce.bindFramebuffer(b.FRAMEBUFFER,Ze);const rt=b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE,0);return b.flush(),await Cy(b,rt,4),b.bindBuffer(b.PIXEL_PACK_BUFFER,Se),b.getBufferSubData(b.PIXEL_PACK_BUFFER,0,re),b.deleteBuffer(Se),b.deleteSync(rt),re}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(E,I=null,B=0){E.isTexture!==!0&&($a("WebGLRenderer: copyFramebufferToTexture function signature has changed."),I=arguments[0]||null,E=arguments[1]);const z=Math.pow(2,-B),N=Math.floor(E.image.width*z),re=Math.floor(E.image.height*z),ce=I!==null?I.x:0,ve=I!==null?I.y:0;C.setTexture2D(E,0),b.copyTexSubImage2D(b.TEXTURE_2D,B,0,0,ce,ve,N,re),Ce.unbindTexture()},this.copyTextureToTexture=function(E,I,B=null,z=null,N=0){E.isTexture!==!0&&($a("WebGLRenderer: copyTextureToTexture function signature has changed."),z=arguments[0]||null,E=arguments[1],I=arguments[2],N=arguments[3]||0,B=null);let re,ce,ve,xe,Te,Ae;B!==null?(re=B.max.x-B.min.x,ce=B.max.y-B.min.y,ve=B.min.x,xe=B.min.y):(re=E.image.width,ce=E.image.height,ve=0,xe=0),z!==null?(Te=z.x,Ae=z.y):(Te=0,Ae=0);const Se=De.convert(I.format),Ze=De.convert(I.type);C.setTexture2D(I,0),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,I.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,I.unpackAlignment);const rt=b.getParameter(b.UNPACK_ROW_LENGTH),ht=b.getParameter(b.UNPACK_IMAGE_HEIGHT),nn=b.getParameter(b.UNPACK_SKIP_PIXELS),Ye=b.getParameter(b.UNPACK_SKIP_ROWS),Me=b.getParameter(b.UNPACK_SKIP_IMAGES),Rt=E.isCompressedTexture?E.mipmaps[N]:E.image;b.pixelStorei(b.UNPACK_ROW_LENGTH,Rt.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,Rt.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,ve),b.pixelStorei(b.UNPACK_SKIP_ROWS,xe),E.isDataTexture?b.texSubImage2D(b.TEXTURE_2D,N,Te,Ae,re,ce,Se,Ze,Rt.data):E.isCompressedTexture?b.compressedTexSubImage2D(b.TEXTURE_2D,N,Te,Ae,Rt.width,Rt.height,Se,Rt.data):b.texSubImage2D(b.TEXTURE_2D,N,Te,Ae,re,ce,Se,Ze,Rt),b.pixelStorei(b.UNPACK_ROW_LENGTH,rt),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,ht),b.pixelStorei(b.UNPACK_SKIP_PIXELS,nn),b.pixelStorei(b.UNPACK_SKIP_ROWS,Ye),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Me),N===0&&I.generateMipmaps&&b.generateMipmap(b.TEXTURE_2D),Ce.unbindTexture()},this.copyTextureToTexture3D=function(E,I,B=null,z=null,N=0){E.isTexture!==!0&&($a("WebGLRenderer: copyTextureToTexture3D function signature has changed."),B=arguments[0]||null,z=arguments[1]||null,E=arguments[2],I=arguments[3],N=arguments[4]||0);let re,ce,ve,xe,Te,Ae,Se,Ze,rt;const ht=E.isCompressedTexture?E.mipmaps[N]:E.image;B!==null?(re=B.max.x-B.min.x,ce=B.max.y-B.min.y,ve=B.max.z-B.min.z,xe=B.min.x,Te=B.min.y,Ae=B.min.z):(re=ht.width,ce=ht.height,ve=ht.depth,xe=0,Te=0,Ae=0),z!==null?(Se=z.x,Ze=z.y,rt=z.z):(Se=0,Ze=0,rt=0);const nn=De.convert(I.format),Ye=De.convert(I.type);let Me;if(I.isData3DTexture)C.setTexture3D(I,0),Me=b.TEXTURE_3D;else if(I.isDataArrayTexture||I.isCompressedArrayTexture)C.setTexture2DArray(I,0),Me=b.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,I.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,I.unpackAlignment);const Rt=b.getParameter(b.UNPACK_ROW_LENGTH),qe=b.getParameter(b.UNPACK_IMAGE_HEIGHT),Pn=b.getParameter(b.UNPACK_SKIP_PIXELS),Cr=b.getParameter(b.UNPACK_SKIP_ROWS),rn=b.getParameter(b.UNPACK_SKIP_IMAGES);b.pixelStorei(b.UNPACK_ROW_LENGTH,ht.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,ht.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,xe),b.pixelStorei(b.UNPACK_SKIP_ROWS,Te),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Ae),E.isDataTexture||E.isData3DTexture?b.texSubImage3D(Me,N,Se,Ze,rt,re,ce,ve,nn,Ye,ht.data):I.isCompressedArrayTexture?b.compressedTexSubImage3D(Me,N,Se,Ze,rt,re,ce,ve,nn,ht.data):b.texSubImage3D(Me,N,Se,Ze,rt,re,ce,ve,nn,Ye,ht),b.pixelStorei(b.UNPACK_ROW_LENGTH,Rt),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,qe),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Pn),b.pixelStorei(b.UNPACK_SKIP_ROWS,Cr),b.pixelStorei(b.UNPACK_SKIP_IMAGES,rn),N===0&&I.generateMipmaps&&b.generateMipmap(Me),Ce.unbindTexture()},this.initRenderTarget=function(E){be.get(E).__webglFramebuffer===void 0&&C.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?C.setTextureCube(E,0):E.isData3DTexture?C.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?C.setTexture2DArray(E,0):C.setTexture2D(E,0),Ce.unbindTexture()},this.resetState=function(){R=0,w=0,A=null,Ce.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ui}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===Vd?"display-p3":"srgb",n.unpackColorSpace=$e.workingColorSpace===jl?"display-p3":"srgb"}}class ev extends Gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new gi,this.environmentIntensity=1,this.environmentRotation=new gi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class z1{constructor(e,n){this.isInterleavedBuffer=!0,this.array=e,this.stride=n,this.count=e!==void 0?e.length/n:0,this.usage=Ff,this.updateRanges=[],this.version=0,this.uuid=Wi()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}addUpdateRange(e,n){this.updateRanges.push({start:e,count:n})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,n,i){e*=this.stride,i*=n.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=n.array[i+r];return this}set(e,n=0){return this.array.set(e,n),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Wi()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const n=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(n,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Wi()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const kt=new U;class Al{constructor(e,n,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=n,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let n=0,i=this.data.count;n<i;n++)kt.fromBufferAttribute(this,n),kt.applyMatrix4(e),this.setXYZ(n,kt.x,kt.y,kt.z);return this}applyNormalMatrix(e){for(let n=0,i=this.count;n<i;n++)kt.fromBufferAttribute(this,n),kt.applyNormalMatrix(e),this.setXYZ(n,kt.x,kt.y,kt.z);return this}transformDirection(e){for(let n=0,i=this.count;n<i;n++)kt.fromBufferAttribute(this,n),kt.transformDirection(e),this.setXYZ(n,kt.x,kt.y,kt.z);return this}getComponent(e,n){let i=this.array[e*this.data.stride+this.offset+n];return this.normalized&&(i=Yn(i,this.array)),i}setComponent(e,n,i){return this.normalized&&(i=et(i,this.array)),this.data.array[e*this.data.stride+this.offset+n]=i,this}setX(e,n){return this.normalized&&(n=et(n,this.array)),this.data.array[e*this.data.stride+this.offset]=n,this}setY(e,n){return this.normalized&&(n=et(n,this.array)),this.data.array[e*this.data.stride+this.offset+1]=n,this}setZ(e,n){return this.normalized&&(n=et(n,this.array)),this.data.array[e*this.data.stride+this.offset+2]=n,this}setW(e,n){return this.normalized&&(n=et(n,this.array)),this.data.array[e*this.data.stride+this.offset+3]=n,this}getX(e){let n=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(n=Yn(n,this.array)),n}getY(e){let n=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(n=Yn(n,this.array)),n}getZ(e){let n=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(n=Yn(n,this.array)),n}getW(e){let n=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(n=Yn(n,this.array)),n}setXY(e,n,i){return e=e*this.data.stride+this.offset,this.normalized&&(n=et(n,this.array),i=et(i,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this}setXYZ(e,n,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(n=et(n,this.array),i=et(i,this.array),r=et(r,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,n,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(n=et(n,this.array),i=et(i,this.array),r=et(r,this.array),s=et(s,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return new hn(new this.array.constructor(n),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Al(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:n,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class tv extends Is{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ke(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Gr;const qs=new U,Wr=new U,Xr=new U,jr=new Ue,$s=new Ue,nv=new ft,Ca=new U,Ks=new U,Ra=new U,im=new Ue,ic=new Ue,rm=new Ue;class H1 extends Gt{constructor(e=new tv){if(super(),this.isSprite=!0,this.type="Sprite",Gr===void 0){Gr=new Rn;const n=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new z1(n,5);Gr.setIndex([0,1,2,0,2,3]),Gr.setAttribute("position",new Al(i,3,0,!1)),Gr.setAttribute("uv",new Al(i,2,3,!1))}this.geometry=Gr,this.material=e,this.center=new Ue(.5,.5)}raycast(e,n){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Wr.setFromMatrixScale(this.matrixWorld),nv.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Xr.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Wr.multiplyScalar(-Xr.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const o=this.center;Pa(Ca.set(-.5,-.5,0),Xr,o,Wr,r,s),Pa(Ks.set(.5,-.5,0),Xr,o,Wr,r,s),Pa(Ra.set(.5,.5,0),Xr,o,Wr,r,s),im.set(0,0),ic.set(1,0),rm.set(1,1);let a=e.ray.intersectTriangle(Ca,Ks,Ra,!1,qs);if(a===null&&(Pa(Ks.set(-.5,.5,0),Xr,o,Wr,r,s),ic.set(0,1),a=e.ray.intersectTriangle(Ca,Ra,Ks,!1,qs),a===null))return;const l=e.ray.origin.distanceTo(qs);l<e.near||l>e.far||n.push({distance:l,point:qs.clone(),uv:Mn.getInterpolation(qs,Ca,Ks,Ra,im,ic,rm,new Ue),face:null,object:this})}copy(e,n){return super.copy(e,n),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Pa(t,e,n,i,r,s){jr.subVectors(t,n).addScalar(.5).multiply(i),r!==void 0?($s.x=s*jr.x-r*jr.y,$s.y=r*jr.x+s*jr.y):$s.copy(jr),t.copy(e),t.x+=$s.x,t.y+=$s.y,t.applyMatrix4(nv)}class iv extends Is{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ke(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const sm=new ft,Bf=new Gd,ba=new Yl,La=new U;class V1 extends Gt{constructor(e=new Rn,n=new iv){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),ba.copy(i.boundingSphere),ba.applyMatrix4(r),ba.radius+=s,e.ray.intersectsSphere(ba)===!1)return;sm.copy(r).invert(),Bf.copy(e.ray).applyMatrix4(sm);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,u=i.index,h=i.attributes.position;if(u!==null){const d=Math.max(0,o.start),m=Math.min(u.count,o.start+o.count);for(let x=d,y=m;x<y;x++){const p=u.getX(x);La.fromBufferAttribute(h,p),om(La,p,l,r,e,n,this)}}else{const d=Math.max(0,o.start),m=Math.min(h.count,o.start+o.count);for(let x=d,y=m;x<y;x++)La.fromBufferAttribute(h,x),om(La,x,l,r,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function om(t,e,n,i,r,s,o){const a=Bf.distanceSqToPoint(t);if(a<n){const l=new U;Bf.closestPointToPoint(t,l),l.applyMatrix4(i);const u=r.ray.origin.distanceTo(l);if(u<r.near||u>r.far)return;s.push({distance:u,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,faceIndex:null,barycoord:null,object:o})}}class G1 extends Vt{constructor(e,n,i,r,s,o,a,l,u){super(e,n,i,r,s,o,a,l,u),this.isCanvasTexture=!0,this.needsUpdate=!0}}class jd extends Rn{constructor(e=[],n=[],i=1,r=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:e,indices:n,radius:i,detail:r};const s=[],o=[];a(r),u(i),f(),this.setAttribute("position",new pn(s,3)),this.setAttribute("normal",new pn(s.slice(),3)),this.setAttribute("uv",new pn(o,2)),r===0?this.computeVertexNormals():this.normalizeNormals();function a(g){const _=new U,S=new U,R=new U;for(let w=0;w<n.length;w+=3)m(n[w+0],_),m(n[w+1],S),m(n[w+2],R),l(_,S,R,g)}function l(g,_,S,R){const w=R+1,A=[];for(let P=0;P<=w;P++){A[P]=[];const V=g.clone().lerp(S,P/w),v=_.clone().lerp(S,P/w),T=w-P;for(let H=0;H<=T;H++)H===0&&P===w?A[P][H]=V:A[P][H]=V.clone().lerp(v,H/T)}for(let P=0;P<w;P++)for(let V=0;V<2*(w-P)-1;V++){const v=Math.floor(V/2);V%2===0?(d(A[P][v+1]),d(A[P+1][v]),d(A[P][v])):(d(A[P][v+1]),d(A[P+1][v+1]),d(A[P+1][v]))}}function u(g){const _=new U;for(let S=0;S<s.length;S+=3)_.x=s[S+0],_.y=s[S+1],_.z=s[S+2],_.normalize().multiplyScalar(g),s[S+0]=_.x,s[S+1]=_.y,s[S+2]=_.z}function f(){const g=new U;for(let _=0;_<s.length;_+=3){g.x=s[_+0],g.y=s[_+1],g.z=s[_+2];const S=p(g)/2/Math.PI+.5,R=c(g)/Math.PI+.5;o.push(S,1-R)}x(),h()}function h(){for(let g=0;g<o.length;g+=6){const _=o[g+0],S=o[g+2],R=o[g+4],w=Math.max(_,S,R),A=Math.min(_,S,R);w>.9&&A<.1&&(_<.2&&(o[g+0]+=1),S<.2&&(o[g+2]+=1),R<.2&&(o[g+4]+=1))}}function d(g){s.push(g.x,g.y,g.z)}function m(g,_){const S=g*3;_.x=e[S+0],_.y=e[S+1],_.z=e[S+2]}function x(){const g=new U,_=new U,S=new U,R=new U,w=new Ue,A=new Ue,P=new Ue;for(let V=0,v=0;V<s.length;V+=9,v+=6){g.set(s[V+0],s[V+1],s[V+2]),_.set(s[V+3],s[V+4],s[V+5]),S.set(s[V+6],s[V+7],s[V+8]),w.set(o[v+0],o[v+1]),A.set(o[v+2],o[v+3]),P.set(o[v+4],o[v+5]),R.copy(g).add(_).add(S).divideScalar(3);const T=p(R);y(w,v+0,g,T),y(A,v+2,_,T),y(P,v+4,S,T)}}function y(g,_,S,R){R<0&&g.x===1&&(o[_]=g.x-1),S.x===0&&S.z===0&&(o[_]=R/2/Math.PI+.5)}function p(g){return Math.atan2(g.z,-g.x)}function c(g){return Math.atan2(-g.y,Math.sqrt(g.x*g.x+g.z*g.z))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new jd(e.vertices,e.indices,e.radius,e.details)}}class Cl extends jd{constructor(e=1,n=0){const i=(1+Math.sqrt(5))/2,r=[-1,i,0,1,i,0,-1,-i,0,1,-i,0,0,-1,i,0,1,i,0,-1,-i,0,1,-i,i,0,-1,i,0,1,-i,0,-1,-i,0,1],s=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(r,s,e,n),this.type="IcosahedronGeometry",this.parameters={radius:e,detail:n}}static fromJSON(e){return new Cl(e.radius,e.detail)}}class Rl extends Rn{constructor(e=1,n=.4,i=12,r=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:n,radialSegments:i,tubularSegments:r,arc:s},i=Math.floor(i),r=Math.floor(r);const o=[],a=[],l=[],u=[],f=new U,h=new U,d=new U;for(let m=0;m<=i;m++)for(let x=0;x<=r;x++){const y=x/r*s,p=m/i*Math.PI*2;h.x=(e+n*Math.cos(p))*Math.cos(y),h.y=(e+n*Math.cos(p))*Math.sin(y),h.z=n*Math.sin(p),a.push(h.x,h.y,h.z),f.x=e*Math.cos(y),f.y=e*Math.sin(y),d.subVectors(h,f).normalize(),l.push(d.x,d.y,d.z),u.push(x/r),u.push(m/i)}for(let m=1;m<=i;m++)for(let x=1;x<=r;x++){const y=(r+1)*m+x-1,p=(r+1)*(m-1)+x-1,c=(r+1)*(m-1)+x,g=(r+1)*m+x;o.push(y,p,g),o.push(p,c,g)}this.setIndex(o),this.setAttribute("position",new pn(a,3)),this.setAttribute("normal",new pn(l,3)),this.setAttribute("uv",new pn(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Rl(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class rv{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=am(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const n=am();e=(n-this.oldTime)/1e3,this.oldTime=n,this.elapsedTime+=e}return e}}function am(){return performance.now()}const lm=new ft;class W1{constructor(e,n,i=0,r=1/0){this.ray=new Gd(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new Wd,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}setFromXRController(e){return lm.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(lm),this}intersectObject(e,n=!0,i=[]){return zf(e,this,i,n),i.sort(um),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)zf(e[r],this,i,n);return i.sort(um),i}}function um(t,e){return t.distance-e.distance}function zf(t,e,n,i){let r=!0;if(t.layers.test(e.layers)&&t.raycast(e,n)===!1&&(r=!1),r===!0&&i===!0){const s=t.children;for(let o=0,a=s.length;o<a;o++)zf(s[o],e,n,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ud}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Ud);function X1(){const t=fn.useRef(null);return fn.useEffect(()=>{const e=t.current;if(!e)return;const n=new J_({canvas:e,antialias:!0,alpha:!1});n.setPixelRatio(Math.min(window.devicePixelRatio,2)),n.setSize(e.clientWidth,e.clientHeight),n.setClearColor(789519,1);const i=new ev,r=new ln(60,e.clientWidth/e.clientHeight,.1,100);r.position.set(0,0,5);const s=2800,o=new Rn,a=new Float32Array(s*3),l=new Float32Array(s);for(let F=0;F<s;F++){const j=Math.random()*Math.PI*2,Q=Math.acos(2*Math.random()-1),G=2.2+Math.random()*1.6;a[F*3]=G*Math.sin(Q)*Math.cos(j),a[F*3+1]=G*Math.sin(Q)*Math.sin(j),a[F*3+2]=G*Math.cos(Q),l[F]=Math.random()*Math.PI*2}o.setAttribute("position",new hn(a,3)),o.setAttribute("phase",new hn(l,1));const u=new iv({size:.022,color:15262940,transparent:!0,opacity:.6,sizeAttenuation:!0}),f=new V1(o,u);i.add(f);const h=new Cl(1.2,1),d=new ss({color:15224092,wireframe:!0,transparent:!0,opacity:.35}),m=new cn(h,d);i.add(m);const x=new Cl(.85,0),y=new ss({color:789519,wireframe:!1,transparent:!0,opacity:.92}),p=new cn(x,y);i.add(p);const c=new Rl(1.7,.006,4,120),g=new ss({color:15224092,transparent:!0,opacity:.3}),_=new cn(c,g);_.rotation.x=Math.PI/2.5,i.add(_);const S=new Rl(2.1,.004,4,120),R=new ss({color:15262940,transparent:!0,opacity:.07}),w=new cn(S,R);w.rotation.x=Math.PI/3.5,w.rotation.y=Math.PI/4,i.add(w);const A={x:0,y:0},P=F=>{A.x=F.clientX/window.innerWidth*2-1,A.y=-(F.clientY/window.innerHeight)*2+1};window.addEventListener("mousemove",P);const V=()=>{const F=e.clientWidth,j=e.clientHeight;n.setSize(F,j),r.aspect=F/j,r.updateProjectionMatrix()};window.addEventListener("resize",V);let v;const T=new rv,H=()=>{v=requestAnimationFrame(H);const F=T.getElapsedTime();m.rotation.x=F*.18+A.y*.3,m.rotation.y=F*.24+A.x*.3,p.rotation.x=m.rotation.x,p.rotation.y=m.rotation.y,f.rotation.y=F*.04+A.x*.08,f.rotation.x=A.y*.06,_.rotation.z=F*.12,_.rotation.y=F*.06+A.x*.1,w.rotation.z=-F*.08,w.rotation.x=Math.PI/3.5+A.y*.05,d.opacity=.28+Math.sin(F*.7)*.08,n.render(i,r)};return H(),()=>{cancelAnimationFrame(v),window.removeEventListener("mousemove",P),window.removeEventListener("resize",V),n.dispose()}},[]),k.jsx("canvas",{ref:t})}const no="AKSHAR",sv="PATEL",j1=no.length+1+sv.length,Y1=150;function q1({count:t}){if(t<=no.length)return k.jsx(k.Fragment,{children:no.slice(0,t)});const e=sv.slice(0,t-no.length-1),n=e.slice(0,2),i=e.slice(2);return k.jsxs(k.Fragment,{children:[no,k.jsx("br",{}),k.jsx("span",{children:n}),i]})}function $1(){const[t,e]=fn.useState(0);return fn.useEffect(()=>{if(t>=j1)return;const n=setTimeout(()=>e(i=>i+1),Y1);return()=>clearTimeout(n)},[t]),k.jsxs("section",{id:"hero",children:[k.jsx(X1,{}),k.jsxs("div",{className:"hero-overlay",children:[k.jsx("div",{className:"hero-eyebrow",children:"Software Developer"}),k.jsxs("h1",{className:"hero-name",children:[k.jsx(q1,{count:t}),k.jsx("span",{className:"hero-cursor",children:"|"})]}),k.jsxs("p",{className:"hero-sub",children:["Recent ",k.jsx("strong",{children:"computer science"})," graduate with experiences and interests of ",k.jsx("strong",{children:"Software and AI Development"}),"."]})]}),k.jsxs("div",{className:"hero-scroll",children:[k.jsx("span",{children:"Scroll"}),k.jsx("div",{className:"scroll-line"})]})]})}const K1=[{num:"01",company:"Intuit",role:"Software Developer Intern",years:"September 2025 — April 2026",tags:["Go","Java","Springboot","Python","AWS"],description:"Designed and engineered a Root Cause Analysis (RCA) automation platform using React.js, integrating backend services with Golang, Java (Spring Boot), AWS (EC2, DynamoDB, API Gateway, CDK), and Docker, enabling real-time outage detection and secure data storage.",bullets:["Developed and optimized network-aware backend systems using Golang, Java, and Spring Boot, applying TCP/IP, HTTP, and gRPC to improve service reliability and performance.","Built a real-time collaboration system using WebSockets, enabling concurrent editing for distributed teams","Developed and scaled backend REST APIs using Java, integrating LangChain pipelines and external AI APIs to support high-throughput RCA workflows across distributed systems.","Built an LLM-driven RCA assistant using Python and LangChain, automating log analysis and root cause summarization, reducing manual triage time by 30%."]},{num:"02",company:"Interac Corp",role:"Software Developer Intern",years:"May 2025 — August 2025",tags:["Next.js","Node.js","PostgreSQL"],description:"Developed and tested Canada’s first Real-Time Rail (RTR) payment system by building scalable microservices using Spring Boot (Java) and Golang within large distributed systems, enabling real-time transaction processing with less than 100ms latency.",bullets:["Leveraged Elixir’s concurrency and TCP socket programming to handle thousands of lightweight processes for concurrent payment processing and transaction isolation over secure channels.","Built resilient, distributed backend services with CockroachDB and PostgreSQL with Java to ensure high availability and consistency in financial data across regions.","Deployed containerized services on AWS (EKS), scaling services for 10k+ concurrent requests/sec with sub 100ms latency."]},{num:"03",company:"First National Financial",role:"Junior Application Developer",years:"May 2023 — May 2024",tags:["React.js","Java","C++","Typescript","AWS"],description:"Designed and built highly reliable and scalable web and mobile applications using React.js, Java, C++, Swift (iOS), TypeScript, Next.js, Node.js, and AWS EC2, serving 100+ daily users, working in a team with a collaborative mindset.",bullets:["Built and integrated GraphQL APIs using Spring Boot (Java) and C++, cutting transfer time by 30%","Developed scalable microservices within large distributed systems using SpringBoot (Java), PostgreSQL, and GCP (Google Cloud), improving system performance and reducing latency by 20%.","Enhanced PostgreSQL database performance by 25% through advanced query optimization, stored procedures, and triggers, ensuring accurate and efficient data retrieval."]},{num:"04",company:"First National Financial",role:"Sofware Developer Intern",years:"May 2022 — August 2022",tags:["Vue.js","Java","Golang"],description:"Developed a responsive front-end interface using Vue.js, increasing user engagement to 300+ active users.",bullets:["Developed & integrated GraphQL APIs with Spring Boot (Java) and Golang, reducing transfer latency by 17%."]}],Z1=[{name:"Claude AI",icon:"🤖"},{name:"Python",icon:"🐍"},{name:"Java",icon:"☕"},{name:"Golang",icon:"🐹"},{name:"React / Next",icon:"⚛️"},{name:"TypeScript",icon:"🔷"},{name:"AWS",icon:"☁️"},{name:"Docker",icon:"🐳"},{name:"PostgreSQL",icon:"🐘"}],Q1=[{num:"01",title:"Data Alpha Engine",subtitle:"AI-Powered quantitative research platform",description:"A full-stack quantitative research platform that ingests unstructured alternative data, extracts predictive signals using LLM embeddings, and backtests them against real equity returns.",tags:["React","Python","TypeScript","Tensorflow","FastAPI","Scikit-learn"],gradient:"blue-violet",link:"https://github.com/akshar1612/DataAlphaEngine"},{num:"02",title:"Real-Time PR-Review Agent",subtitle:"Automated PR-Review Agent",description:"An AI-powered code review agent that clones a PR, runs static analysis, understands context across the codebase using RAG, and leaves structured review comments — with confidence scores and links to relevant past issues.",tags:["Python","React","ChromaDB","AWS EKS","TypeScript"],gradient:"cyan-blue",link:"https://github.com/akshar1612/PR-Review-Agent"},{num:"03",title:"Path Finding Visualizer",subtitle:"Interactive Pathfinding Visualizer",description:"An interactive pathfinding algorithm visualizer built with Next.js, TypeScript, and Tailwind CSS. Place a start and end node, draw walls, choose an algorithm, and watch it search in real time.",tags:["React","Typescript","Tailwind","Next.js"],gradient:"violet-pink",link:"https://akshar1612.github.io/Path-Finder-Visualizer/"}],J1=["Software Developer","·","Python","·","Three.js","·","React","·","Artificial Intelligence","·","Claude Code","·","Cursor","·","Open to Work","·","Software Developer","·","Python","·","Three.js","·","React","·","Artificial Intelligence","·","Claude Code","·","Cursor","·","Open to Work","·"];function ew(){return k.jsx("div",{className:"marquee-bar",children:k.jsx("div",{className:"marquee-track",children:J1.map((t,e)=>k.jsx("span",{className:t==="·"?"sep":"",children:t},e))})})}function tw(){const[t,e]=fn.useState(null);return k.jsxs("section",{id:"work",children:[k.jsxs("div",{className:"work-header",children:[k.jsx("h2",{className:"section-title",children:"Experience"}),k.jsx("span",{className:"section-label",children:"04 roles"})]}),k.jsx("div",{className:"exp-list",children:K1.map((n,i)=>{const r=t===i;return k.jsxs("div",{className:`exp-row${r?" exp-row--open":""}`,children:[k.jsxs("div",{className:"exp-header",onClick:()=>e(r?null:i),children:[k.jsx("div",{className:"proj-num",children:n.num}),k.jsxs("div",{className:"exp-main",children:[k.jsx("div",{className:"exp-company",children:n.company}),k.jsxs("div",{className:"exp-meta",children:[k.jsx("span",{className:"exp-role",children:n.role}),k.jsx("span",{className:"exp-dot",children:"·"}),k.jsx("span",{className:"exp-years",children:n.years})]})]}),k.jsx("div",{className:"exp-tags",children:n.tags.map((s,o)=>k.jsx("span",{children:s},o))}),k.jsxs("div",{className:"exp-toggle",children:[k.jsx("span",{}),k.jsx("span",{})]})]}),k.jsx("div",{className:"exp-body",children:k.jsx("div",{className:"exp-body-inner",children:k.jsxs("div",{className:"exp-content-wrap",children:[k.jsx("div",{className:"exp-accent-line"}),k.jsxs("div",{className:"exp-content",children:[k.jsx("p",{className:"exp-desc",children:n.description}),k.jsx("ul",{className:"exp-bullets",children:n.bullets.map((s,o)=>k.jsxs("li",{style:{"--delay":`${o*.09+.28}s`},children:[k.jsx("span",{className:"bullet-mark"}),s]},o))})]})]})})})]},i)})})]})}function nw(){return k.jsxs("section",{id:"projects",children:[k.jsxs("div",{className:"projects-header",children:[k.jsx("h2",{className:"section-title",children:"Projects"}),k.jsx("span",{className:"section-label",children:"Selected Work"})]}),k.jsx("div",{className:"projects-grid",children:Q1.map((t,e)=>k.jsx(iw,{project:t,index:e},t.num))})]})}function iw({project:t,index:e}){const{num:n,title:i,subtitle:r,description:s,tags:o,gradient:a,link:l}=t;return k.jsxs("a",{href:l,target:"_blank",rel:"noopener noreferrer",className:`proj-card proj-card--${a}`,style:{animationDelay:`${e*.1}s`},children:[k.jsx("div",{className:"proj-card-glow"}),k.jsxs("div",{className:"proj-card-top",children:[k.jsx("span",{className:"proj-card-num",children:n}),k.jsx("div",{className:"proj-card-arrow",children:"↗"})]}),k.jsxs("div",{className:"proj-card-body",children:[k.jsx("p",{className:"proj-card-subtitle",children:r}),k.jsx("h3",{className:"proj-card-title",children:i}),k.jsx("p",{className:"proj-card-desc",children:s})]}),k.jsx("div",{className:"proj-card-footer",children:o.map(u=>k.jsx("span",{className:"proj-card-tag",children:u},u))})]})}const rw=[{label:"JS",name:"JavaScript",bg:"#F7DF1E",fg:"#222222"},{label:"TS",name:"TypeScript",bg:"#3178C6",fg:"#ffffff"},{label:"Python",name:"Python",bg:"#3776AB",fg:"#FFE873"},{label:"Java",name:"Java",bg:"#5382A1",fg:"#ffffff"},{label:"C/C++",name:"C / C++",bg:"#00599C",fg:"#ffffff"},{label:"Go",name:"Golang",bg:"#00ACD7",fg:"#ffffff"},{label:"C#",name:"C Sharp",bg:"#9B4F96",fg:"#ffffff"},{label:"React",name:"React",bg:"#20232A",fg:"#61DAFB"},{label:"Vue",name:"Vue.js",bg:"#42B883",fg:"#ffffff"},{label:"Spring",name:"Spring Boot",bg:"#6DB33F",fg:"#ffffff"},{label:"Node",name:"Node.js",bg:"#215732",fg:"#8CC84B"},{label:"Next",name:"Next.js",bg:"#111111",fg:"#ffffff"},{label:"AWS",name:"AWS",bg:"#232F3E",fg:"#FF9900"},{label:"Docker",name:"Docker",bg:"#2496ED",fg:"#ffffff"},{label:"Git",name:"Git",bg:"#F05032",fg:"#ffffff"},{label:"CSS",name:"CSS 3",bg:"#264DE4",fg:"#ffffff"},{label:"SQL",name:"PostgreSQL",bg:"#336791",fg:"#ffffff"},{label:"Obj-C",name:"Objective-C",bg:"#333333",fg:"#ffffff"}],sw=[[-5.7,2,.2],[-3.4,2.1,-.3],[-1.1,1.9,.4],[1.2,2,-.2],[3.5,1.9,.1],[5.8,2.1,-.4],[-5.9,.1,-.3],[-3.6,0,.5],[-1.3,.2,-.1],[1,.1,.3],[3.4,0,-.4],[6,.2,.2],[-5.8,-1.9,.3],[-3.5,-2,-.2],[-1.2,-1.8,.5],[1.1,-1.9,-.3],[3.6,-1.8,.1],[5.9,-2,-.5]];function ow(t,e,n,i){const s=document.createElement("canvas");s.width=s.height=256;const o=s.getContext("2d");o.shadowOffsetX=0,o.shadowOffsetY=5,o.shadowBlur=18,o.shadowColor="rgba(0,0,0,0.45)";const a=8,l=32;o.beginPath(),o.moveTo(a+l,a),o.lineTo(256-a-l,a),o.arcTo(256-a,a,256-a,a+l,l),o.lineTo(256-a,256-a-l),o.arcTo(256-a,256-a,256-a-l,256-a,l),o.lineTo(a+l,256-a),o.arcTo(a,256-a,a,256-a-l,l),o.lineTo(a,a+l),o.arcTo(a,a,a+l,a,l),o.closePath(),o.fillStyle=n,o.fill(),o.shadowColor="transparent",o.strokeStyle="rgba(255,255,255,0.10)",o.lineWidth=1.5,o.stroke();const u=t.length<=2?90:t.length<=3?80:t.length<=4?64:t.length<=5?54:44;return o.font=`${u}px Impact, "Arial Black", sans-serif`,o.fillStyle=i,o.textAlign="center",o.textBaseline="middle",o.fillText(t,256/2,256/2-10),o.font="400 19px Arial, sans-serif",o.fillStyle=i,o.globalAlpha=.42,o.fillText(e.toUpperCase(),256/2,256/2+u/2+6),o.globalAlpha=1,new G1(s)}function aw(){const t=fn.useRef(null);return fn.useEffect(()=>{const e=t.current;if(!e)return;const n=new J_({canvas:e,antialias:!0,alpha:!1});n.setPixelRatio(Math.min(window.devicePixelRatio,2)),n.setSize(e.clientWidth,e.clientHeight),n.setClearColor(789519,1);const i=new ev,r=new ln(50,e.clientWidth/e.clientHeight,.1,100);r.position.set(0,0,7);const s=[],o=rw.map((R,w)=>{const A=ow(R.label,R.name,R.bg,R.fg),P=new tv({map:A,transparent:!0}),V=new H1(P),[v,T,H]=sw[w];return V.position.set(v,T,H),V.scale.set(1.04,1.04,1.04),i.add(V),s.push(V),{sprite:V,origPos:new U(v,T,H),vel:new U,phase:Math.random()*Math.PI*2,speed:.35+Math.random()*.45,k:.018+Math.random()*.016,dragged:!1}}),a={x:0,y:0};let l=null;const u=new W1,f=new Ue,h=new Ri(new U(0,0,1),0),d=new U,m=R=>{const w=e.getBoundingClientRect();f.x=(R.clientX-w.left)/w.width*2-1,f.y=-((R.clientY-w.top)/w.height)*2+1},x=R=>{if(m(R),a.x=f.x,a.y=f.y,l)u.setFromCamera(f,r),u.ray.intersectPlane(h,d),l.sprite.position.copy(d),l.vel.set(0,0,0);else{const w=e.getBoundingClientRect();if(R.clientX>=w.left&&R.clientX<=w.right&&R.clientY>=w.top&&R.clientY<=w.bottom){u.setFromCamera(f,r);const P=u.intersectObjects(s);e.style.cursor=P.length>0?"grab":"default"}}},y=R=>{m(R),u.setFromCamera(f,r);const w=u.intersectObjects(s);w.length>0&&(l=o.find(A=>A.sprite===w[0].object),l&&(l.dragged=!0,l.vel.set(0,0,0),h.setFromNormalAndCoplanarPoint(r.getWorldDirection(new U),l.sprite.position),e.style.cursor="grabbing"))},p=()=>{l&&(l.dragged=!1,l=null,e.style.cursor="default")};window.addEventListener("mousemove",x),e.addEventListener("mousedown",y),window.addEventListener("mouseup",p);const c=()=>{const R=e.clientWidth,w=e.clientHeight;n.setSize(R,w),r.aspect=R/w,r.updateProjectionMatrix()};window.addEventListener("resize",c);let g;const _=new rv,S=()=>{g=requestAnimationFrame(S);const R=_.getElapsedTime();o.forEach(w=>{if(w.dragged)return;const A=w.origPos.x+a.x*.65,P=w.origPos.y+Math.sin(R*w.speed+w.phase)*.22+a.y*.25,V=w.origPos.z,v=.91;w.vel.x=(w.vel.x+(A-w.sprite.position.x)*w.k)*v,w.vel.y=(w.vel.y+(P-w.sprite.position.y)*w.k)*v,w.vel.z=(w.vel.z+(V-w.sprite.position.z)*w.k)*v,w.sprite.position.x+=w.vel.x,w.sprite.position.y+=w.vel.y,w.sprite.position.z+=w.vel.z}),n.render(i,r)};return S(),()=>{cancelAnimationFrame(g),window.removeEventListener("mousemove",x),e.removeEventListener("mousedown",y),window.removeEventListener("mouseup",p),window.removeEventListener("resize",c),n.dispose()}},[]),k.jsx("canvas",{ref:t})}function lw(t){const e=t.currentTarget,{left:n,top:i,width:r,height:s}=e.getBoundingClientRect(),o=(t.clientX-n)/r-.5,a=(t.clientY-i)/s-.5;e.style.transform=`perspective(400px) rotateY(${o*40}deg) rotateX(${-a*40}deg) scale(1.06)`}function uw(t){t.currentTarget.style.transform="perspective(600px) rotateY(0deg) rotateX(0deg) scale(1)"}function cw(t){t.currentTarget.style.animation="none"}function fw(){return k.jsxs("section",{id:"about",children:[k.jsxs("div",{className:"about-left",children:[k.jsxs("h2",{className:"about-title",children:["ABOUT",k.jsx("br",{}),"ME"]}),k.jsxs("div",{className:"about-body",children:[k.jsxs("p",{children:["👋 Hey, I'm ",k.jsx("strong",{children:"Akshar Patel"}),"!"]}),k.jsxs("p",{children:["🎓 Recent graduate from ",k.jsx("strong",{children:"Wilfrid Laurier University"})," with a Bachelor's of Computer Science."]}),k.jsxs("p",{children:["🤖 I'm obsessed with ",k.jsx("strong",{children:"AI"})," and what you can build when you mix it with solid engineering."]}),k.jsxs("p",{children:["🧠 Recently I've been working on an ",k.jsx("strong",{children:"AI-powered quantitative research platform"})," because why not let machines do the hard thinking."]}),k.jsxs("p",{children:["🏢 I've shipped real products at ",k.jsx("strong",{children:"Intuit"}),", ",k.jsx("strong",{children:"Interac Corp"}),", and ",k.jsx("strong",{children:"First National Financial (twice)"})," and I'm just getting started."]})]})]}),k.jsxs("div",{className:"about-right",children:[k.jsx("h3",{style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:"1.6rem",letterSpacing:"0.05em",marginBottom:"1.5rem",color:"var(--fg)"},children:"LANGUAGES & TOOLS"}),k.jsx("div",{className:"skill-grid",children:Z1.map((t,e)=>k.jsxs("div",{className:"skill-card",style:{animationDelay:`${e*.07}s`,transition:"transform 0.12s ease"},onMouseMove:lw,onMouseLeave:uw,onAnimationEnd:cw,children:[k.jsx("span",{className:"skill-card-icon",children:t.icon}),k.jsx("span",{className:"skill-card-name",children:t.name})]},e))})]})]})}function dw(){return k.jsxs("section",{id:"contact",children:[k.jsx("div",{className:"contact-bg",children:"HELLO"}),k.jsx("div",{className:"contact-label",children:"Let's work together"}),k.jsxs("h2",{className:"contact-headline",children:["WANT TO",k.jsx("br",{}),k.jsx("em",{children:"CONNECT?"}),k.jsx("br",{}),"SEND ME AN EMAIL."]}),k.jsxs("a",{href:"mailto:aksharp448@gmail.com",className:"cta-btn cta-btn--pulse",children:["Send me a message ",k.jsx("span",{children:"↗"})]}),k.jsxs("div",{className:"contact-links",children:[k.jsx("a",{href:"https://www.linkedin.com/in/akshar-patel-35b6461a3/",target:"_blank",rel:"noreferrer",children:"LinkedIn"}),k.jsx("a",{href:"https://github.com/akshar1612",target:"_blank",rel:"noreferrer",children:"GitHub"})]})]})}function hw(){return k.jsx("footer",{children:k.jsx("a",{href:"#hero",style:{fontSize:"0.7rem",letterSpacing:"0.12em",textTransform:"uppercase",color:"var(--fg-dim)"},children:"Back to top ↑"})})}function pw(){return k.jsxs("div",{children:[k.jsx(Fx,{}),k.jsx($1,{}),k.jsx(ew,{}),k.jsx(fw,{}),k.jsx(tw,{}),k.jsx(nw,{}),k.jsxs("div",{id:"canvas3d-section",children:[k.jsx(aw,{}),k.jsx("div",{className:"canvas3d-label",children:k.jsx("div",{className:"eyebrow",children:"Skills & Tools — drag to explore"})})]}),k.jsx(dw,{}),k.jsx(hw,{})]})}M_(document.getElementById("root")).render(k.jsx(fn.StrictMode,{children:k.jsx(pw,{})}));
